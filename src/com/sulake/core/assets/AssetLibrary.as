package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_743:String = "AssetLibraryReady";
      
      public static const const_1360:String = "AssetLibraryUnloaded";
      
      public static const const_501:String = "AssetLibraryLoaded";
      
      public static const const_1318:String = "AssetLibraryLoadError";
       
      
      private var var_512:XML;
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         var_728 = new Dictionary(false);
         var_132 = new Dictionary(false);
         var_1057.push(this);
      }
      ...
      public function unload() : void
      {
         ...
         for(_loc1_ in var_728)
         {
            delete var_728[_loc1_];
         }
         if(var_14 != null)
         {
            var_14.dispose();
         ...
         var_310 = false;
         _file = null;
         dispatchEvent(new Event(AssetLibrary.const_1360));
      }
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         var_512 = _loc2_.manifest.copy();
         var_357 = _loc2_.resource;
         _file = _loc2_.url;
         if(var_511)
         {
            AssetLibrary.fetchLibraryContents(this,var_512,var_357);
         }
         var_310 = true;
         dispatchEvent(new Event(AssetLibrary.const_501));
         dispatchEvent(new Event(AssetLibrary.const_743));
         if(var_511)
         {
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = var_416[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_944,assetLoadEventHandler);
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_855,assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         var_416[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      private function loadErrorHandler(param1:Event) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1318));
         var_14 = null;
      }
      ...
      {
         var _loc2_:Class = var_728[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = var_512.child("library");
         if(_loc2_ == null)
         {
      ...
      {
         var _loc2_:IAsset = var_132[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = var_416[loader.url];
         if(struct == null)
         {
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.const_36:
               ...
               if(decl != null)
               {
                  ...
                  var_132[struct.assetName] = asset;
               }
               else
               {
                  e = new AssetLoaderEvent(AssetLoaderEvent.const_51,e.status);
