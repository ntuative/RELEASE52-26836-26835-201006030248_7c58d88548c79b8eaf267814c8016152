package com.sulake.core.assets
{
   ...
   public class BitmapDataAsset implements IAsset
   {
      ...
      protected static var var_668:uint = 0;
      
      protected static var var_669:uint = 0;
      ...
      private var var_1167:AssetTypeDeclaration;
      ...
      public function setUnknownContent(param1:Object) : void
      {
         ...
         if(param1 is BitmapDataAsset)
         {
            _bitmap = BitmapDataAsset(param1)._bitmap;
            _offset = BitmapDataAsset(param1)._offset;
            var_1000 = BitmapDataAsset(param1).var_1000;
            var_999 = BitmapDataAsset(param1).var_999;
            if(_bitmap != null)
            {
               return;
            }
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               case "offset":
                  ...
                  break;
               case "flipH":
                  var_1000 = _loc4_ == "1" || _loc4_ == "true";
                  break;
               case "flipV":
                  var_999 = _loc4_ == "1" || _loc4_ == "true";
                  break;
            }
            _loc2_++;
         }
