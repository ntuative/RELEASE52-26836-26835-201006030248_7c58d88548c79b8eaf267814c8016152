package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1433:uint = 1;
      
      public static const const_885:int = 5;
      
      protected static const const_1104:uint = 7;
      
      protected static const const_1435:uint = 4;
      
      protected static const const_1434:uint = 3;
      ...
      protected var var_2335:String = "";
      
      protected var var_512:XML;
      
      protected var var_1153:Boolean = true;
      ...
      protected function prepareLibrary() : void
      {
         ...
         var_512 = new XML(bytes.readUTFBytes(bytes.length));
      }
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         if(var_462 == LibraryLoader.const_1434)
         {
            if(analyzeLibrary())
            {
               var_462 |= 0;
         ...
         if(var_462 == LibraryLoader.const_1104)
         {
            var_661 = true;
            prepareLibrary();
            removeEventListeners();
