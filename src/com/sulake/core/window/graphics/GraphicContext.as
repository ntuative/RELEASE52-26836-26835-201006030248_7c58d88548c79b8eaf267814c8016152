package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1619:uint = 128;
      
      public static const const_1573:uint = 64;
      ...
      protected var var_666:Boolean;
      
      protected var var_1666:Boolean;
         ...
         if(var_666)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new BitmapData(width,height,var_1666,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new BitmapData(1,1,var_1666,16777215);
                  }
                  var_386 += bitmap.width * bitmap.height * 4;
               }
