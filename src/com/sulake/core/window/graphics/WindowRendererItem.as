package com.sulake.core.window.graphics
{
   ...
   public class WindowRendererItem implements IDisposable
   {
      ...
      private static const const_794:uint = 1;
      ...
      private var var_145:WindowRenderer;
      
      private var var_1033:uint;
      
      private var _colorTransform:ColorTransform;
      
      private var var_711:uint;
      ...
      public function invalidate(param1:IWindow, param2:Rectangle, param3:uint) : Boolean
      {
         ...
         switch(param3)
         {
            ...
            case WindowRedrawFlag.const_856:
               var_711 = var_710.getTheActualState(param1.type,param1.style,param1.state);
               if(var_711 != var_1033)
               {
                  var_226 = true;
                  _loc4_ = true;
            ...
            case WindowRedrawFlag.const_1011:
               ...
               break;
            case WindowRedrawFlag.const_267:
               _loc4_ = true;
         }
         if(_loc4_)
         {
      ...
      {
         return var_710.getTheActualState(param1.type,param1.style,param1.state) != var_1033;
      }
      ...
      public function render(param1:IWindow, param2:Point, param3:Rectangle) : Boolean
      {
         var _loc4_:* = null;
         var _loc11_:* = 0;
         var _loc5_:uint = !!param1.background ? uint(const_793) : uint(const_519);
         var _loc7_:ISkinRenderer = resolveSkinRenderer(param1);
         if(_loc7_ != null)
         {
            if(_loc7_.isStateDrawable(var_711))
            {
               _loc5_ = const_794;
            }
         }
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc5_ == const_794)
               {
                  ...
                  if(var_226)
                  {
                     ...
                     _loc7_.draw(param1,var_94,var_94.rect,var_711,false);
                  ...
                  if(param1.blend < 1 && param1.testParamFlag(WindowParam.const_35))
                  {
                     ...
                     _loc4_.draw(var_94,var_978,_colorTransform,null,param3,false);
                     param3.offset(-param2.x,-param2.y);
                  }
                  else
                  {
      ...
      {
         var _loc2_:ISkinRenderer = var_710.getSkinRendererByTypeAndStyle(param1.type,param1.style);
         if(_loc2_ == null)
         {
            if(param1.style != WindowStyle.const_989)
            {
               _loc2_ = var_710.getSkinRendererByTypeAndStyle(param1.type,WindowStyle.const_989);
            }
         }
         return _loc2_;
      }
