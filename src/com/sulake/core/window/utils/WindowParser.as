package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_891:String = "_EXCLUDE";
      
      public static const const_1664:String = "_TEMP";
      ...
      protected var var_1150:Dictionary;
      
      private var _disposed:Boolean = false;
      
      protected var var_981:Dictionary;
      
      protected var var_1435:Map;
      
      protected var var_16:IWindowContext;
      
      protected var var_1434:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(var_1151,var_1150);
         var_981 = new Dictionary();
         var_1434 = new Dictionary();
         ParamCodeTable.fillTables(var_981,var_1434);
         var_1435 = new Map();
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            for(_loc1_ in var_1151)
            {
               delete var_1151[_loc1_];
            }
            for(_loc1_ in var_1150)
            {
               delete var_1150[_loc1_];
            }
            for(_loc1_ in var_981)
            {
               delete var_981[_loc1_];
            }
            for(_loc1_ in var_1434)
            {
               delete var_1434[_loc1_];
            }
            var_1435.dispose();
            var_1435 = null;
            var_16 = null;
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_891) == -1)
                  {
