package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_815:String = "margin_top";
      
      private static const const_1161:String = "_HEADER";
      
      private static const const_818:String = "margin_right";
      
      private static const const_1162:String = "_SCALER";
      
      private static const const_1115:String = "_TITLE";
      
      private static const const_1160:String = "_CONTENT";
      
      private static const const_816:String = "margin_left";
      
      private static const const_817:String = "margin_bottom";
      ...
      private var var_1395:IHeaderWindow;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_816,_loc3_.left,PropertyStruct.const_67,_loc2_));
         _loc1_.push(new PropertyStruct(const_815,_loc3_.top,PropertyStruct.const_67,_loc2_));
         _loc1_.push(new PropertyStruct(const_818,0 - _loc3_.right,PropertyStruct.const_67,_loc2_));
         _loc1_.push(new PropertyStruct(const_817,0 - _loc3_.bottom,PropertyStruct.const_67,_loc2_));
         return _loc1_;
      }
      ...
      public function get header() : IHeaderWindow
      {
         if(var_1395 == null)
         {
            var_1395 = findChildByTag(const_1161) as IHeaderWindow;
            if(!var_1395)
            {
      ...
      public function get title() : ITextWindow
      {
         if(_title == null)
         {
            _title = findChildByTag(const_1115) as ITextWindow;
            if(!_title)
            {
      ...
      {
         return findChildByTag(const_1162) as IScalerWindow;
      }
      ...
      {
         return content != null && var_661 ? content.iterator : new Iterator(this);
      }
      ...
      public function get content() : IWindowContainer
      {
         if(var_20 == null)
         {
            var_20 = findChildByTag(const_1160) as IWindowContainer;
            if(!var_20)
            {
