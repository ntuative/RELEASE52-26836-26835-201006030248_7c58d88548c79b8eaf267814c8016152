package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_863:IItemListWindow;
      
      private var var_354:IScrollbarWindow;
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_354)
         {
            var_354 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(var_354)
            {
               var_354.addEventListener(WindowEvent.const_281,scrollBarEventProc);
               var_354.addEventListener(WindowEvent.const_249,scrollBarEventProc);
            }
         }
         return var_354;
      }
      ...
      override public function dispose() : void
      {
         if(var_354)
         {
            var_354.removeEventListener(WindowEvent.const_281,scrollBarEventProc);
            var_354.removeEventListener(WindowEvent.const_249,scrollBarEventProc);
            var_354 = null;
         }
         if(var_863)
         {
      ...
      {
         if(param1.type == WindowEvent.const_281)
         {
            showScrollBar();
         }
         else if(param1.type == WindowEvent.const_249)
         {
            hideScrollBar();
         }
      }
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!var_863)
         {
            var_863 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
         return var_863;
      }
