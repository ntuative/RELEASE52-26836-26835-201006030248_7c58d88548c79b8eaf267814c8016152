package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow
   {
      ...
      protected static const const_1441:Boolean = false;
      
      protected static const DEF_SPACING:int = 0;
      
      protected static const const_1054:String = "scale_to_fit_items";
      
      protected static const DEF_RESIZE_ON_ITEM_UPDATE:Boolean = false;
      
      protected static const const_1440:Boolean = true;
      ...
      protected var var_2411:Number = 0.0;
      
      protected var var_562:Boolean = false;
      
      protected var var_2412:Number = 0.0;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         var_93 = 0;
         var_69 = 0;
         _horizontal = param2 == WindowType.const_338;
         super(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11);
         var_167 = var_659 || !testParamFlag(WindowParam.const_35);
         _container = var_16.create("_CONTAINER","",WindowType.const_358,WindowStyle.const_344,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[WindowController.INTERNAL_CHILD_TAG,WindowController.EXCLUDE_CHILD_TAG]) as IWindowContainer;
      ...
      {
         return new Rectangle(var_561 * maxScrollH,var_560 * maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_1057,_spacing,PropertyStruct.const_67,_spacing != DEF_SPACING));
         _loc1_.push(new PropertyStruct(const_1056,var_799,PropertyStruct.const_63,var_799 != const_1440));
         _loc1_.push(new PropertyStruct(const_1054,var_562,PropertyStruct.const_63,var_562 != const_1441));
         _loc1_.push(new PropertyStruct(const_1055,var_1158,PropertyStruct.const_63,var_1158 != DEF_RESIZE_ON_ITEM_UPDATE));
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case const_1055:
                  ...
                  break;
               case const_1056:
                  var_799 = _loc2_.value as Boolean;
                  break;
            }
         }
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(_container)
         {
            if(_horizontal)
            {
               _container.setParamFlag(WindowParam.const_403,param1);
            }
            else
            {
