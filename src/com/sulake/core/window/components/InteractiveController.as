package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      protected var var_2344:uint = 0;
      
      protected var var_980:String = "";
      
      protected var var_465:Array;
      
      protected var var_979:uint = 500;
      
      public function InteractiveController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         param4 |= 0;
         var_465 = new Array();
         var_465[0] = MouseCursorType.ARROW_LINK;
         var_465[1] = MouseCursorType.const_43;
         var_465[2] = MouseCursorType.ARROW_LINK;
         var_465[3] = MouseCursorType.ARROW_LINK;
         var_465[4] = MouseCursorType.const_43;
         var_465[5] = MouseCursorType.const_43;
         var_465[6] = MouseCursorType.ARROW_LINK;
         if(var_335 == null)
         {
            var_335 = new Array();
            var_335[0] = WindowState.const_103;
            var_335[1] = WindowState.const_81;
            var_335[2] = WindowState.const_86;
            var_335[3] = WindowState.const_69;
            var_335[4] = WindowState.WINDOW_STATE_SELECTED;
            var_335[5] = WindowState.const_97;
      ...
      {
         param2.push(new PropertyStruct(const_1053,param1.toolTipCaption,PropertyStruct.STRING,param1.toolTipCaption != const_769));
         param2.push(new PropertyStruct(KEY_TOOLTIP_DELAY,param1.toolTipDelay,PropertyStruct.const_877,param1.toolTipDelay != const_1439));
         return param2;
      }
      ...
      {
         var_980 = param1 == null ? const_769 : param1;
      }
