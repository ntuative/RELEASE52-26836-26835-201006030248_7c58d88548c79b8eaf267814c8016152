package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      public static const const_994:uint = 4;
      
      public static const COMPONENT_EVENT_ERROR:String = "COMPONENT_EVENT_ERROR";
      
      public static const const_1668:uint = 1;
      ...
      protected var var_1152:uint;
      
      protected var _isDisposed:Boolean = false;
      
      protected var var_987:String = "";
      ...
      protected var var_1835:Boolean = false;
      ...
      public function release(param1:IID) : uint
      {
         ...
         if(_loc2_ == null)
         {
            var_987 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(var_987);
         }
         var _loc3_:uint = _loc2_.release();
         if(var_1152 & const_994)
         {
            if(_loc3_ == 0)
            {
