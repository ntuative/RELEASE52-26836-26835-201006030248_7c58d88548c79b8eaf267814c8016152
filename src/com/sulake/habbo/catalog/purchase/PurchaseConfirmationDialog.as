package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1464:uint = 4.294967295E9;
      
      private const const_1463:uint = 4.293848814E9;
      ...
      private function suggestionsEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               _loc5_ = var_245.findChildByName("suggestion_list") as IItemListWindow;
               if(_loc5_ == null)
               {
                  return;
               }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == var_958;
               }
            }
            _loc4_++;
         }
      ...
      private function updatePreview() : void
      {
         ...
         _loc3_ = _loc2_.getFurnitureImage(var_958,new Vector3d(180),64,this,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
      ...
      {
         return param1 % 2 == 0 ? uint(const_1463) : uint(const_1464);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               _catalog.purchaseProduct(var_452,var_79,var_1132);
               dispose();
               break;
            case "cancel_button":
      ...
      private function selectHighlighted() : void
      {
         ...
         var _loc1_:IItemListWindow = var_245.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(var_958);
         var _loc8_:int = !!_loc6_ ? 0 : int(var_650[_boxIndex]);
         var _loc9_:int = !!_loc6_ ? 0 : int(var_649[var_211]);
         _catalog.purchaseProductAsGift(var_452,var_79,var_1132,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_55:
               ...
               break;
            case WindowKeyboardEvent.const_768:
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            var_1504 = _loc1_.stuffTypes;
            var_650 = _loc1_.boxTypes;
            var_649 = _loc1_.ribbonTypes;
            var_958 = var_1504[0];
            _boxIndex = var_650[0];
            var_211 = var_649[0];
            initColorGrid();
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         var _loc2_:IItemListWindow = var_245.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(var_245 == null)
         {
            var_245 = _window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(var_546 == null)
         {
            var_546 = createWindow("suggestion_list_item") as IWindowContainer;
            var_546.procedure = suggestionsEventHandler;
         }
         if(var_245 == null || var_546 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = var_245.findChildByName("suggestion_list") as IItemListWindow;
         ...
         {
            _loc5_ = var_546.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
