package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      public static const const_176:int = 5;
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(var_1656)
         {
            case RecyclerStatusMessageEvent.const_1375:
               var_282 = const_376;
               if(_view == null)
               {
                  return;
               ...
               break;
            case RecyclerStatusMessageEvent.const_919:
               if(_view == null)
               {
                  return;
               }
               ...
               break;
            case RecyclerStatusMessageEvent.const_1259:
               if(_view == null)
               {
                  return;
               }
      ...
      {
         return var_1656 != RecyclerStatusMessageEvent.const_919;
      }
      
      private function get statusActive() : Boolean
      {
         return var_282 != const_821;
      }
      ...
      {
         return active && var_282 == const_376;
      }
      ...
      public function placeObjectAtSlot(param1:int, param2:int, param3:int, param4:int, param5:String) : void
      {
         ...
         if(false)
         {
            ...
            newSlotId = 0;
            while(oldObjectData != null && newSlotId < const_176)
            {
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_857:
               if(_view != null)
               {
