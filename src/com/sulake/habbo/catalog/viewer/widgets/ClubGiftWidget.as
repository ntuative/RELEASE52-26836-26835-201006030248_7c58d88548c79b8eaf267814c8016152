package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ClubGiftWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private function updateList() : void
      {
         ...
         for each(_loc6_ in _loc2_)
         {
            ...
            if(_loc5_)
            {
               ...
               var_640.add(_loc1_.offerId,_loc1_);
            }
         }
      }
      ...
      private function showPreview(param1:Offer, param2:Rectangle) : void
      {
         ...
         if(!var_213)
         {
            var_213 = createWindow("club_gift_preview") as IWindowContainer;
         }
         if(!var_213)
         {
            return;
         }
         var _loc5_:IBitmapWrapperWindow = var_213.findChildByName("image") as IBitmapWrapperWindow;
         if(!_loc5_)
         {
            return;
         }
         ...
         var_213.setGlobalPosition(_loc6_.subtract(new Point(0,0)));
      ...
      {
         if(!param1 || !param2 || !var_640 || !var_29)
         {
            return;
         }
         ...
         var _loc3_:Offer = var_640.getValue(param2.id) as Offer;
         if(!_loc3_)
         {
            return;
         }
