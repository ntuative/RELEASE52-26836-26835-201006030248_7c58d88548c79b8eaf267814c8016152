package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1581:Point;
      
      private var var_2092:Array;
      
      private var var_625:IItemGridWindow;
      
      private var var_88:IBitmapWrapperWindow;
      
      private var var_1289:ITextWindow;
      
      private var var_1321:IScrollbarWindow;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(var_625 != null)
         {
            var_625.visible = false;
            var_625.destroyGridItems();
         }
         if(var_1321 != null)
         {
         ...
         if(_loc3_ != null)
         {
            var_1289.text = "${" + _loc3_.name + "}";
            var_1288.text = "${" + _loc3_.description + "}";
         }
         else
         {
            var_1289.text = "${" + _loc2_.localizationId + "}";
            var_1288.text = "${" + _loc2_.localizationId + "}";
         }
         if(ProductImageConfiguration.hasProductImage(_loc2_.localizationId))
         {
            setPreviewFromAsset(ProductImageConfiguration.const_40[_loc2_.localizationId]);
         }
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_473:
                  ...
                  if(var_625 != null)
                  {
                     ...
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_625,var_1321,var_1398);
                  }
                  break;
                  ...
                  switch(_loc6_.productType)
                  {
                     ...
                     case ProductTypeEnum.const_224:
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           _loc13_ = _loc12_.avatarRenderManager.createAvatarImage(_loc14_,AvatarScaleType.const_58);
                           if(_loc13_ != null)
                           {
                              _loc13_.setDirection(AvatarSetType.const_46,3);
                              _loc13_.initActionAppends();
                              _loc13_.appendAction(AvatarAction.const_285,AvatarAction.const_471);
                              _loc13_.appendAction(AvatarAction.const_514,_loc6_.productClassId);
      ...
      {
         var_1289 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         var_1288 = _window.findChildByName("ctlg_description") as ITextWindow;
         var_88 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         var_1581 = new Point(var_88.x,var_88.y);
         var_625 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1321 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_625 == null)
         {
