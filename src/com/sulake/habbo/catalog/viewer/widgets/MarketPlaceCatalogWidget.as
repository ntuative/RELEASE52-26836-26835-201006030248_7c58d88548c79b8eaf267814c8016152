package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private var var_945:MarketPlaceOfferData;
      
      private const const_1458:int = 1;
      
      private const const_1737:int = 40;
      ...
      private const const_1736:int = 10;
      ...
      private function updateList() : void
      {
         ...
         if(!var_537)
         {
            ...
            var_537 = _loc4_.buildFromXML(_loc3_) as IWindowContainer;
         }
         if(!var_537)
         {
            return;
         ...
         if(!var_449)
         {
            var_449 = new Timer(25);
            var_449.addEventListener(TimerEvent.TIMER,onPopulationTimer);
         }
         var_944 = 0;
         populateList();
         var_449.start();
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         if(!marketPlace || !param2 || !_itemList || !var_640)
         {
            return;
         }
         var _loc3_:* = [];
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !_itemList || !var_537 || true)
         {
            return;
         }
         var _loc2_:IWindowContainer = var_537.clone() as IWindowContainer;
      ...
      {
         var _loc5_:* = null;
         updateStatusDisplay(const_1458);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
      ...
      override public function dispose() : void
      {
         ...
         if(var_449)
         {
            var_449.removeEventListener(TimerEvent.TIMER,onPopulationTimer);
            var_449 = null;
         }
      }
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(var_944 >= var_640.length)
            {
               return true;
            }
            addListItem(var_640.getWithIndex(var_944));
            ++var_944;
            _loc1_++;
         }
         return false;
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  marketPlace.buyOffer(var_945.offerId);
            }
            return;
         }
      ...
      private function onWidgetEvent(param1:WindowEvent, param2:IWindow = null) : void
      {
         ...
         else if(param1.type == WindowEvent.const_122)
         {
