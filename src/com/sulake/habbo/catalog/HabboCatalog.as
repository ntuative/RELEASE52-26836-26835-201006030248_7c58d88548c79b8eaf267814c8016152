package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private var var_425:ClubBuyController;
      ...
      private var var_2073:Boolean = true;
      
      private var _roomEngine:IRoomEngine;
      
      private var var_424:ICatalogNavigator;
      ...
      private var var_1073:ClubGiftController;
      ...
      {
         return var_377.getProductData(param1);
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         updatePurse();
         if(!var_2074 && var_517 != null)
         {
            var_517.playSound(HabboSoundTypesEnum.const_866);
         }
         var_2074 = false;
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = var_377.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_85)
         {
            _loc3_ = var_377.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      private function createClubBuyController() : void
      {
         if(var_425 == null)
         {
            var_425 = new ClubBuyController(this);
         }
      }
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_104:
               var_1306 = param1.session.isPrivateRoom;
               if(var_86 != null)
               {
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         {
            if(false && "true" == var_162.getKey("client.credits.embed.enabled"))
            {
               ExternalInterface.call("FlashExternalInterface.openHabblet","credits");
            }
            else
            {
               _loc3_ = var_162.getKey("link.format.credits");
               if(_loc3_ != "")
               {
      ...
      private function method_8(param1:GiftWrappingConfigurationEvent) : void
      {
         if(param1 == null)
         {
            return;
         }
         var_2075 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(!var_890)
         {
            if(!var_377.loadProductData(this))
            {
               return;
            }
            init();
         ...
         {
            var_194.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_49,HabboToolbarIconEnum.CATALOGUE,_mainContainer));
         }
         if(false)
         {
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         var_1073.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         var_424 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function createClubGiftController() : void
      {
         if(var_1073 == null)
         {
            var_1073 = new ClubGiftController(this);
         }
      }
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:ICatalogPage, param3:String = "") : void
      {
         ...
         else if(param1 is Offer)
         {
            if(var_200 == null)
            {
               var_200 = new PurchaseConfirmationDialog(_localization);
            }
            _loc7_ = [];
            if(_friendList != null)
            {
            ...
            var_200.showOffer(this,param1,param2,param3,_loc7_);
         ...
         {
            var_425.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      {
         var_194.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_120,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         _communication.addHabboConnectionMessageEvent(new GiftWrappingConfigurationEvent(method_8));
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         var_424.buildCatalogIndex(_loc2_);
         if(var_1074 != "")
         {
            var_424.openPage(var_1074);
            var_1074 = "";
         }
         else
         {
            var_424.openFrontPage();
         }
      }
      ...
      private function noPixelsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         if(param2.type == WindowEvent.const_193)
         {
            _loc3_ = var_162.getKey("link.format.pixels");
            if(_loc3_ != "")
            {
               _windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,onExternalLink);
               HabboWebTools.navigateToURL(_loc3_,"habboMain");
      ...
      private function onPixelsBalance(param1:IMessageEvent) : void
      {
         ...
         updatePurse();
         if(!var_2073 && var_517 != null)
         {
            var_517.playSound(HabboSoundTypesEnum.const_975);
         }
         var_2073 = false;
      }
