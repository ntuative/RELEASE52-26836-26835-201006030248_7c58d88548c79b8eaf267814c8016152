package com.sulake.habbo.communication.demo
{
   ...
   public class HabboHotelView implements IDisposable
   {
      ...
      private var var_646:Function;
      
      private var _window:IWindowContainer;
      
      private var var_778:IAssetLibrary;
      ...
      private function hotelViewLoadedCallbackHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var _loc3_:IAsset = var_778.getAssetByName(_loc2_.assetName);
      ...
      {
         var _loc3_:AssetLoaderStruct = var_778.loadAssetFromFile("hotel_view_banner_" + var_954,new URLRequest(param1),"image/png");
         if(param2 == null)
         {
      ...
      {
         var _loc3_:AssetLoaderStruct = var_778.loadAssetFromFile("hotelview_png",new URLRequest(param1),"image/png");
         if(param2 == null)
         {
