package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_2070:PseudoRandom;
      
      private var _windowManager:IHabboWindowManager;
      
      private var _habboConfiguration:IHabboConfigurationManager;
      
      private var var_1571:ILogger;
      
      private var var_1299:String;
      
      private var var_2068:String;
      
      private const const_1443:String = "fuselogin";
      
      private var var_314:ICoreCommunicationManager;
      
      private var var_419:IKeyExchange;
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_2069)
         {
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_732 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(var_732);
            _loc2_.send(_loc4_);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         param1.send(new VersionCheckMessageComposer(401,var_1299,var_2068));
         var _loc2_:String = "";
         var _loc3_:SharedObject = SharedObject.getLocal(const_1443,"/");
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var_419.generateSharedKey(_loc4_,10);
         var _loc5_:String = var_419.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,var_2070);
      ...
      private function onUniqueMachineId(param1:UniqueMachineIDEvent) : void
      {
         ...
         var _loc2_:SharedObject = SharedObject.getLocal(const_1443,"/");
      ...
      {
         var_732 = _habboConfiguration.getKey("sso.ticket",null);
         var_1299 = _habboConfiguration.getKey("flash.client.url","");
         var_2068 = _habboConfiguration.getKey("external.variables.txt","");
         if(var_181 == null)
         {
         ...
         if(var_732 != null)
         {
            var_59.mode = HabboConnectionType.const_444;
            var_59.initConnection(HabboConnectionType.const_297);
         }
      }
      
      private function receiveLoggerInterface(param1:IID, param2:IUnknown) : void
      {
         var_1571 = param2 as ILogger;
      }
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         var_2070 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(var_59.mode)
         {
            case HabboConnectionType.const_444:
               _loc6_ = "";
               ...
               var_1067 = _loc4_;
               var_181.loadBannerImage(_loc7_ + "?token=" + var_1067,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_848:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1286:
               var_617 = generateRandomHexString(30);
               var_419 = new DiffieHellman(new BigInteger(_habboConfiguration.getKey("connection.development.prime"),16),new BigInteger(_habboConfiguration.getKey("connection.development.generator"),16));
               var_419.init(var_617);
               _loc8_ = var_419.getPublicKey(10);
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,var_1067);
         ...
         var_419 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = generateRandomHexString(30);
            var_419.init(_loc14_);
            _loc15_ = var_419.getPublicKey(10);
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               var_59.mode = HabboConnectionType.const_848;
            }
         }
         var_59.initConnection(HabboConnectionType.const_297);
      }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         if(param2 != null)
         {
            ...
            Component(_habboConfiguration).events.addEventListener(HabboConfigurationEvent.const_181,onConfigurationLoaded);
         }
      }
