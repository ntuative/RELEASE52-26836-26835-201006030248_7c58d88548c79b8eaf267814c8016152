package com.sulake.habbo.communication.protocol
{
   ...
   public class WedgieProtocol implements IProtocol
   {
      ...
      public static const const_1179:uint = 1;
      
      public static const const_1350:uint = 2;
       
      
      private var var_875:IProtocolDecoder;
      
      private var var_1058:IProtocolEncoder;
      
      public function WedgieProtocol()
      {
         super();
         var_1058 = new WedgieEncoder();
         var_875 = new WedgieDecoder();
      }
      ...
      public function getMessages(param1:ByteArray, param2:Array) : uint
      {
         ...
         while(param1.bytesAvailable)
         {
            ...
            if(_loc5_ == const_1179)
            {
               _loc4_.position = 0;
               _loc6_ = var_875.getID(_loc4_);
