package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_375:int = 10;
      
      private static const const_1159:Number = 18;
      ...
      {
         _widget.method_12(var_1122,var_1121,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_1122,var_774,var_1121,_roomId,_roomCategory,param1);
      }
      ...
      public function define(param1:RoomWidgetChatUpdateEvent) : void
      {
         ...
         var_1122 = param1.userId;
         var_774 = param1.userName;
         var_1121 = param1.userCategory;
      ...
      public function renderView() : void
      {
         ...
         if(_loc19_ != null)
         {
            if(_loc2_)
            {
               _width += _loc19_.textWidth + const_375;
            }
            else
            {
               _loc19_.text = var_774 + ":";
               _loc19_.y += var_453;
               _loc19_.width = _loc19_.textWidth + const_375;
               _width += _loc19_.textWidth + const_375;
            }
         }
         if(_loc20_ != null)
         {
            if(var_1385 == RoomWidgetChatUpdateEvent.const_272)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_774);
            }
            else if(var_1385 == RoomWidgetChatUpdateEvent.const_252)
            {
               _loc20_.text = _localizations.registerParameter("widget.chatbubble.petrespect","petname",var_774);
            }
            else
            {
         ...
         if(_loc22_ != null)
         {
            _loc22_.width = _loc19_.textWidth + const_375 + _loc20_.textWidth + const_528;
            _loc37_ = new Matrix();
      ...
      {
         _widget.onItemMouseDown(var_1122,var_1121,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_1122,var_1121,_roomId,_roomCategory,param1);
      }
