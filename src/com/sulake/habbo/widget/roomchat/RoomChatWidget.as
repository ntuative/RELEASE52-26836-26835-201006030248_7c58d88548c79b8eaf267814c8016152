package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatWidget extends RoomWidgetBase implements IUpdateReceiver
   {
      ...
      private static const const_1065:int = 6000;
      
      private static const const_1062:int = 9;
      ...
      private static const const_1063:int = 25;
      
      private static const const_1066:int = 1;
      
      private static const const_366:int = 9;
      
      private static const const_517:int = 8;
      
      private static const const_365:int = 0;
      
      private static const const_773:int = (const_517 + const_365) * const_105 + const_105;
       
      
      private var var_807:Number = 1;
      
      private var _disposed:Boolean = false;
      
      private var var_571:int = 18;
      ...
      private var var_676:Point;
      
      private var var_1449:Number = 0;
      ...
      public function RoomChatWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:int, param6:Component)
      {
         ...
         var_1694 = param5;
         var_38 = param1.createWindow("chat_container","",HabboWindowType.const_59,HabboWindowStyle.const_43,HabboWindowParam.const_42,new Rectangle(0,0,200,var_192 + RoomChatHistoryPulldown.const_79),null,0) as IWindowContainer;
         var_38.background = true;
         var_38.color = 33554431;
         var_38.tags.push("room_widget_chat");
         var_338 = param1.createWindow("chat_contentlist","",HabboWindowType.const_831,HabboWindowStyle.const_42,0 | 0,new Rectangle(0,0,200,var_192),null,0) as IItemListWindow;
         var_38.addChild(var_338);
         var_123 = param1.createWindow("chat_active_content","",HabboWindowType.const_59,HabboWindowStyle.const_42,HabboWindowParam.const_73,new Rectangle(0,0,200,var_192),null,0) as IWindowContainer;
         var_338.addListItem(var_123);
         var_26 = new RoomChatHistoryViewer(this,param1,var_38,param2);
         var_1695 = int(param4.getKey("chat.history.item.max.count","150"));
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetChatUpdateEvent.const_608,onChatMessage);
         param1.addEventListener(RoomWidgetRoomViewUpdateEvent.const_270,onRoomViewUpdate);
         param1.addEventListener(RoomWidgetRoomViewUpdateEvent.const_587,onRoomViewUpdate);
         param1.addEventListener(RoomWidgetRoomViewUpdateEvent.const_725,onRoomViewUpdate);
      ...
      public function resetArea() : void
      {
         ...
         animationStop();
         var_192 = const_773 + const_366;
         var_38.height = var_192 + var_26.pulldownBarHeight;
         var_338.width = 0 - 0;
         var_338.height = var_192;
         var_123.width = 0 - 0;
         if(historyViewerActive())
         {
            var_123.height = getTotalContentHeight() + const_366;
         }
         else
         {
            var_123.height = var_192;
         }
         var_338.scrollV = 1;
         if(!historyViewerActive())
         {
      ...
      public function resizeContainerToLowestItem() : void
      {
         ...
         if(Math.abs(_loc3_) < RoomChatHistoryViewer.const_974)
         {
            resetArea();
            return;
         }
      ...
      private function processBuffer() : void
      {
         ...
         while(var_67.length > const_1066 || historyViewerActive() && false)
         {
         ...
         {
            activateItemFromBuffer();
            var_677 = getTimer() + const_771;
         }
         else
         {
            if(false && false)
            {
               var_571 = getItemSpacing(_itemList["-1"],var_67[0]);
            }
            else
            {
               var_571 = const_105;
      ...
      private function setChatItemLocHorizontal(param1:RoomChatItem) : void
      {
         ...
         var _loc2_:Number = (param1.senderX + var_676.x) * var_807;
      ...
      public function method_12(param1:int, param2:int, param3:int, param4:int, param5:WindowMouseEvent) : void
      {
      }
      ...
      public function mouseUp() : void
      {
         ...
         if(var_1169 && !historyViewerActive())
         {
            resetArea();
            var_1169 = false;
         }
      ...
      {
         return "chat_" + var_1694.toString() + "_item_" + (var_1696++).toString();
      }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetChatUpdateEvent.const_608,onChatMessage);
         param1.removeEventListener(RoomWidgetRoomViewUpdateEvent.const_270,onRoomViewUpdate);
         param1.removeEventListener(RoomWidgetRoomViewUpdateEvent.const_587,onRoomViewUpdate);
         param1.removeEventListener(RoomWidgetRoomViewUpdateEvent.const_725,onRoomViewUpdate);
      }
      ...
      private function setChatItemLocVertical(param1:RoomChatItem) : void
      {
         ...
         if(param1 != null)
         {
            ...
            _loc3_ = !!historyViewerActive() ? 0 : Number(var_472);
            if(_loc2_ == -1)
            {
               param1.y = getAreaBottom() - (_loc3_ + 1) * const_105 - const_366;
            }
            else
            {
      ...
      public function update(param1:uint) : void
      {
         ...
         if(var_402)
         {
            _loc2_ = param1 / const_1063 * const_1064;
            if(_loc2_ + include > var_571)
            {
               _loc2_ = var_571 - include;
            }
            if(_loc2_ > 0)
            {
               moveItemsUp(_loc2_);
      ...
      private function onRoomViewUpdate(param1:RoomWidgetRoomViewUpdateEvent) : void
      {
         ...
         if(param1.scale > 0)
         {
            if(var_1449 == 0)
            {
               var_1449 = param1.scale;
            }
            else
            {
               var_807 = param1.scale / var_1449;
            }
         }
         if(param1.positionDelta != null)
         {
            var_676.x += param1.positionDelta.x / var_807;
            var_676.y += param1.positionDelta.y / var_807;
         }
         if(param1.rect != null)
         {
            if(var_26 == null)
      ...
      private function purgeItems() : void
      {
         ...
         var _loc1_:int = 0;
         var _loc3_:int = 0;
         while(_itemList.length > var_1695)
         {
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(false)
               {
                  ...
                  {
                     _loc1_.screenLevel = _loc3_ + Math.max(var_472,1);
                  }
               }
               else
               {
               ...
               _loc1_.aboveLevels = var_472;
               if(_loc1_.aboveLevels > const_517 + const_365 + 2)
               {
                  _loc1_.aboveLevels = const_517 + const_365 + 2;
               }
               var_472 = 0;
      ...
      public function stretchAreaBottomTo(param1:Number) : void
      {
         ...
         var_192 = param1 - 0;
         var_38.height = var_192 + RoomChatHistoryPulldown.const_79;
         if(var_26 != null)
         {
            var_26.containerResized(var_38.rectangle);
         }
      ...
      private function selectItemsToMove() : void
      {
         ...
         while(_loc3_ >= 0)
         {
            ...
            if(_loc4_.view != null)
            {
               if(_loc4_.screenLevel > const_365 || _loc4_.screenLevel == _loc2_ - 1 || _loc1_ - _loc4_.timestamp >= const_1065)
               {
