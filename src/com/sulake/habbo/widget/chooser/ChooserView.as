package com.sulake.habbo.widget.chooser
{
   ...
   public class ChooserView
   {
      ...
      private const const_1464:uint = 0;
      ...
      public function removeItem(param1:int, param2:int) : void
      {
         ...
         populate(_items,var_1609);
      }
      
      private function highlightItem(param1:int) : void
      {
         var _loc2_:* = null;
         if(_itemList == null || param1 < 0 || param1 > _itemList.numListItems || param1 == var_751)
         {
            return;
         }
         if(var_751 != -1)
         {
            _loc2_ = _itemList.getListItemAt(var_751) as IWindowContainer;
            if(_loc2_ != null)
            {
               _loc2_.color = !!(var_751 % 2) ? uint(const_1464) : uint(const_1463);
            }
         }
      ...
      public function populate(param1:Array, param2:Boolean) : void
      {
         ...
         while(_loc6_ < param1.length)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               _loc5_.color = !!(_loc6_ % 2) ? uint(const_1464) : uint(const_1463);
