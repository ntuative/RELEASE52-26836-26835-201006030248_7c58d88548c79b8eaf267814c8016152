package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1724:uint = 6710886;
      
      private var _window:IItemListWindow;
      
      private const const_1720:String = "level";
      
      private var var_105:IItemListWindow;
      
      private const const_1728:String = "energy";
      ...
      private const const_1725:uint = 3355443;
      ...
      private const const_1723:uint = 11184810;
      
      private const const_1722:String = "experience";
      ...
      private function createWindow(param1:String) : void
      {
         ...
         if(var_221 != null)
         {
            var_105 = var_221.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
      ...
      {
         if(var_105 == null || var_221 == null || var_63 == null)
         {
            return;
         }
         ...
         var_221.height = NaN;
         _window.width = Math.max(var_221.width,var_63.width);
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = var_1243.getValue(var_592) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         ageText = param1.age;
         updateStateElement(const_1720,param1.level,param1.levelMax);
         updateStateElement(const_1722,param1.experience,param1.experienceMax);
         updateStateElement(const_1728,param1.energy,param1.energyMax);
         ...
         updateWindow();
         var_592 = param1.id;
         var_1243.remove(param1.id);
         var_1243.add(param1.id,param1);
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(var_177 && var_177.getPetId() == var_592)
               {
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1727,const_1721,false);
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),const_1723);
         var _loc6_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc5_.fillRect(_loc6_,const_1725);
         var _loc7_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc7_.width = _loc3_ * _loc7_.width;
         _loc5_.fillRect(_loc7_,const_1724);
         return _loc5_;
      }
