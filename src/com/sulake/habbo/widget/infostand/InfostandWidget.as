package com.sulake.habbo.widget.infostand
{
   ...
   public class InfostandWidget extends RoomWidgetBase
   {
      ...
      private const const_1468:String = "infostand_user_view";
      
      private var var_318:InfoStandPetView;
      
      private var var_1243:InfoStandPetData;
      
      private var var_139:Timer;
      
      private var var_926:InfoStandFurniView;
      
      private var var_428:InfostandFurniData;
      
      private var var_368:InfoStandBotView;
      
      private var _mainContainer:IWindowContainer;
      
      private const const_1467:String = "infostand_bot_view";
      
      private var _config:IHabboConfigurationManager;
      
      private const const_1466:String = "infostand_pet_view";
      
      private const const_1469:String = "infostand_furni_view";
      ...
      public function InfostandWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager)
      {
         ...
         _config = param4;
         var_926 = new InfoStandFurniView(this,const_1469);
         var_205 = new InfoStandUserView(this,const_1468);
         var_318 = new InfoStandPetView(this,const_1466);
         var_368 = new InfoStandBotView(this,const_1467);
         var_429 = new InfostandUserData();
         var_428 = new InfostandFurniData();
         var_1243 = new InfoStandPetData();
         var_139 = new Timer(const_1734);
      ...
      private function onUserTags(param1:RoomWidgetUserTagsUpdateEvent) : void
      {
         ...
         {
            var_205.setTags(param1.tags,var_2210);
         }
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetFurniInfoUpdateEvent.const_633,onFurniInfo);
         ...
         param1.addEventListener(RoomWidgetBadgeImageUpdateEvent.const_747,onBadgeImage);
      ...
      private function onUpdateTimer(param1:TimerEvent) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_422,var_318.getCurrentPetId()));
      }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetFurniInfoUpdateEvent.const_633,onFurniInfo);
         ...
         param1.removeEventListener(RoomWidgetBadgeImageUpdateEvent.const_747,onBadgeImage);
      ...
      private function onRoomObjectRemoved(param1:RoomWidgetRoomObjectUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetRoomObjectUpdateEvent.const_266:
               ...
               {
                  _loc2_ = param1.id == var_1243.roomIndex;
                  break;
               }
