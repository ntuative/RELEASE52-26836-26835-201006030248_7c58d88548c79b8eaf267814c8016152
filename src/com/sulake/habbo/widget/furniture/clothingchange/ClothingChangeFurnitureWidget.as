package com.sulake.habbo.widget.furniture.clothingchange
{
   ...
   public class ClothingChangeFurnitureWidget extends RoomWidgetBase
   {
      ...
      private static const const_776:String = "Girl";
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetClothingChangeUpdateEvent.const_982,onUpdate);
         param1.addEventListener(RoomWidgetClothingChangeUpdateEvent.const_316,onUpdate);
      ...
      private function showGenderSelectionInterface(param1:RoomWidgetClothingChangeUpdateEvent) : void
      {
         ...
         var_1745 = param1.objectCategory;
         ...
         _window = windowManager.createWindow("clothing change gender selection","",HabboWindowType.const_59,HabboWindowStyle.const_42,0 | 0 | 0 | 0,new Rectangle(100,100,200,200),null,0) as IWindowContainer;
         ...
         _loc4_ = _window.findChildByName(const_776);
         if(_loc4_ != null)
         {
            _loc4_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onGenderSelectionMouseEvent);
         }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetClothingChangeUpdateEvent.const_982,onUpdate);
         param1.removeEventListener(RoomWidgetClothingChangeUpdateEvent.const_316,onUpdate);
      }
      ...
      private function requestEditor(param1:String) : void
      {
         ...
         var_581 = _loc4_;
         var_581.offset(100,100);
         var _loc6_:IWindow = var_581.findChildByTag("close");
         if(_loc6_ != null)
         {
            _loc6_.procedure = onEditorWindowClose;
         }
         var _loc7_:* = null;
         _loc7_ = new RoomWidgetClothingChangeMessage(RoomWidgetClothingChangeMessage.const_353,param1,var_158,var_1745,_roomId,_roomCategory,_loc5_);
      ...
      private function hideEditorInterface() : void
      {
         ...
         if(var_581 != null)
         {
            _loc1_ = var_581 as IFrameWindow;
            if(_loc1_ != null)
            {
