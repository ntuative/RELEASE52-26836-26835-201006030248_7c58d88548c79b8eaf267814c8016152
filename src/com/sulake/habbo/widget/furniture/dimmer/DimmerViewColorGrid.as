   ...
   public class DimmerViewColorGrid
   {
      ...
      private function populateColourGrid(param1:IHabboWindowManager) : void
      {
         ...
         for each(_loc2_ in colors)
         {
            ...
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(var_927.width,var_927.height,true,0);
            ...
            if(_loc6_ != null)
            {
               _loc6_.bitmap = new BitmapData(var_757.width,var_757.height,true,16777215);
               _loc6_.bitmap.copyPixels(var_757,var_757.rect,new Point(0,0),null,null,true);
      ...
      {
         var _loc2_:int = var_441.getGridItemIndex(param1.target as IWindow);
      ...
      public function setSelectedColorIndex(param1:int) : void
      {
         ...
         if(param1 < 0 || param1 >= var_441.numGridItems)
         {
            return;
         }
         select(var_441.getGridItemAt(param1) as IWindowContainer);
      }
      ...
      private function select(param1:IWindowContainer) : void
      {
         ...
         if(var_294 != null)
         {
            _loc2_ = var_294.getChildByName("chosen");
            if(_loc2_ != null)
            {
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         var_927 = BitmapData(_loc3_.content);
         _loc3_ = BitmapDataAsset(param1.getAssetByName("dimmer_color_selected"));
         var_757 = BitmapData(_loc3_.content);
      }
