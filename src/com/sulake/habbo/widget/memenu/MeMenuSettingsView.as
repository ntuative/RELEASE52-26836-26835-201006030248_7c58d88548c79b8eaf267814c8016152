package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSettingsView implements IMeMenuView
   {
      ...
      private var var_790:MeMenuSettingsViewSlider;
      ...
      {
         var_789 = param1.volume;
         if(var_790 != null)
         {
            var_790.setValue(var_789);
         }
         setSoundsOffIcon();
         setSoundsOnIcon();
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var_790 = new MeMenuSettingsViewSlider(this,_window.findChildByName("volume_container") as IWindowContainer,_widget.assets,0,1);
         setSoundsOffIcon();
         setSoundsOnIcon();
         ...
         _widget.messageListener.processWidgetMessage(new RoomWidgetGetSettingsMessage(RoomWidgetGetSettingsMessage.const_735));
      }
      ...
      private function onButtonOut(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            case "sounds_off":
               if(var_789 != 0)
               {
                  setBitmapWrapperContent("sounds_off_icon",var_1660);
               }
               break;
            case "sounds_on":
               if(var_789 != 1)
      ...
      private function setSoundsOffIcon(param1:BitmapData = null) : void
      {
         ...
         {
            setBitmapWrapperContent("sounds_off_icon",var_1658);
         }
         else
         {
            setBitmapWrapperContent("sounds_off_icon",var_1660);
      ...
      private function setSoundsOnIcon(param1:BitmapData = null) : void
      {
         ...
         {
            setBitmapWrapperContent("sounds_on_icon",var_1659);
         }
         else
         {
            setBitmapWrapperContent("sounds_on_icon",var_1657);
