package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1471:int = 5;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_1111 = _localization.getKey("widgets.chatinput.mode.whisper",":tell");
         var_2233 = _localization.getKey("widgets.chatinput.mode.shout",":shout");
         var_2234 = _localization.getKey("widgets.chatinput.mode.speak",":speak");
         var_766 = new Timer(1000,1);
         var_766.addEventListener(TimerEvent.TIMER_COMPLETE,onTypingTimerComplete);
         var_936 = new Timer(5000,1);
         var_936.addEventListener(TimerEvent.TIMER_COMPLETE,onIdleTimerComplete);
         createWindow();
         refreshView();
      }
      ...
      private function createWindow() : void
      {
         ...
         _loc4_.addEventListener(WindowEvent.const_48,method_10);
         _loc4_.addEventListener(WindowEvent.const_122,onInputChanged);
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         var_2232 = _loc2_.width + const_528 + _loc6_.width + const_1148;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1147,_loc8_.width) + const_528);
            _loc8_.x = _loc12_;
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == var_1111 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  var_142 = "";
               }
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(var_536);
