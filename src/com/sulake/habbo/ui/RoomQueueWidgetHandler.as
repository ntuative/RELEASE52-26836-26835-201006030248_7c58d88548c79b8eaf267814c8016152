package com.sulake.habbo.ui
{
   ...
   public class RoomQueueWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionQueueEvent.const_477:
               ...
               if(_loc7_.length > 1)
               {
                  if(_loc6_ && _loc2_.queueTypes.indexOf(RoomSessionQueueEvent.const_836) != -1)
                  {
                     _loc8_ = _loc2_.getQueueSize(RoomSessionQueueEvent.const_836) + 1;
                     _loc9_ = true;
                  }
                  else
                  {
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetRoomQueueMessage.const_556);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetRoomQueueMessage.CHANGE_TO_SPECTATOR_QUEUE:
               ...
               break;
            case RoomWidgetRoomQueueMessage.const_556:
               _container.roomSession.changeQueue(RoomSessionQueueEvent.const_1030);
               break;
            case RoomWidgetRoomQueueMessage.const_559:
               if(false)
               {
                  _container.catalog.openCatalogPage(CatalogPageName.const_208,true);
               }
         }
         return null;
      }
      ...
      {
         return [RoomSessionQueueEvent.const_477];
      }
