package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IAvatarImageListener
   {
      ...
      private var var_929:Number = 0.0;
      
      private var var_533:Point = null;
      
      private var var_761:Map = null;
      ...
      {
         return [RoomSessionChatEvent.const_156];
      }
      ...
      public function dispose() : void
      {
         ...
         if(var_369 != null)
         {
            ...
            {
               _loc2_ = var_369.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionChatEvent.const_156:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           _loc13_ = var_369.getValue(_loc15_) as BitmapData;
                           _loc12_ = uint(var_761.getValue(_loc15_));
                           if(_loc13_ == null)
                           {
                              if(false)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_310:
                                 ...
                                 if(_loc13_ != null)
                                 {
                                    var_369.add(_loc15_,_loc13_);
                                 }
                                 if(_loc12_ != 0)
                                 {
                                    var_761.add(_loc15_,_loc12_);
                                 }
                                 if(_loc16_ != null)
                                 {
                                    _loc16_.dispose();
      ...
      {
         return [RoomWidgetChatMessage.const_594,RoomWidgetChatSelectAvatarMessage.const_752];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_594:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":v":
                              _loc10_ = new RoomSessionChatEvent(RoomSessionChatEvent.const_156,_container.roomSession,0,"Version 26836-26835-201006030237");
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_533 == null)
            {
               ...
               var_534.y = 0;
               var_534.z = 0;
               var_533 = _loc4_.getScreenPoint(var_534);
            ...
            var_534.y = 0;
            var_534.z = 0;
            _loc8_ = _loc4_.getScreenPoint(var_534);
            if(_loc8_ != null)
            {
               if(_loc8_.x != var_533.x || _loc8_.y != var_533.y)
               {
                  _loc9_ = PointMath.sub(_loc8_,PointMath.mul(var_533,_loc5_));
