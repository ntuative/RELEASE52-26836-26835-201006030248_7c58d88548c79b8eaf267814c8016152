package com.sulake.habbo.ui
{
   ...
   public class FriendRequestWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetUserLocationMessage.const_602);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_531);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_687);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case FriendRequestEvent.const_253:
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetUserLocationMessage.const_602:
            ...
            case RoomWidgetFriendRequestMessage.const_531:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_687:
      ...
      public function getProcessedEvents() : Array
      {
         ...
         _loc1_.push(FriendRequestEvent.const_253);
         return _loc1_;
      }
