   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver
   {
      ...
      private function setMeMenuToolbarIcon(param1:Boolean) : void
      {
         ...
         if(false)
         {
            ...
            _loc6_ = _container.avatarRenderManager.createAvatarImage(_loc4_,AvatarScaleType.const_58,_loc5_);
            if(_loc6_ != null)
            {
         ...
         if(_loc3_ != null)
         {
            ...
            Logger.log("MeMenuWidgetHandler: set toolbar icon: " + var_194 + " " + _loc7_);
            if(var_194 != null && _loc7_ != null)
            {
               _loc9_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_869,HabboToolbarIconEnum.MEMENU);
               _loc9_.bitmapData = _loc7_;
               var_194.events.dispatchEvent(_loc9_);
            }
         }
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_689,onFigureUpdate);
            }
            if(false)
            {
            ...
            if(false)
            {
               _container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_513,onHelpTutorialEvent);
         ...
         if(_container != null && false)
         {
            _container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_689,onFigureUpdate);
            _container.sessionDataManager.events.addEventListener(SessionCreditBalanceEvent.const_185,onCreditBalance);
         }
         var_11 = _container.inventory;
         if(var_11 != null)
         {
            (var_11 as Component).events.addEventListener(HabboInventoryEffectsEvent.const_905,onAvatarEffectsChanged);
            (var_11 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_854,onHabboClubSubscriptionChanged);
         }
         ...
         if(false)
         {
            _container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_513,onHelpTutorialEvent);
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HabboHelpTutorialEvent.const_513:
               _container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_421));
         }
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_701);
         _loc1_.push(RoomWidgetDanceMessage.const_539);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_685);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_763);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_635);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_690);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_642);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_641);
         _loc1_.push(RoomWidgetStopEffectMessage.const_663);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1335);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_950);
         _loc1_.push(RoomWidgetToolbarMessage.const_535);
         _loc1_.push(RoomWidgetToolbarMessage.const_570);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_324);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1214);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1013);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_655);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_681);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_735);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1314);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_681:
               ...
               break;
            case RoomWidgetWaveMessage.const_701:
               if(_container != null && false)
               {
            ...
            case RoomWidgetDanceMessage.const_539:
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_685:
               if(var_11 != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_763:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_635:
               if(var_11 != null)
               {
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_641:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(_catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_958)
               {
               ...
               if(var_11 != null)
               {
                  ...
                  switch(_loc3_.inventoryType)
                  {
                     case RoomWidgetOpenInventoryMessage.const_1049:
                        _catalog.openCatalogPage(CatalogPageName.const_1388,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_932:
                        var_11.toggleInventoryPage(InventoryCategory.const_254);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1325:
            ...
            case RoomWidgetStopEffectMessage.const_663:
            ...
            case RoomWidgetSetToolbarIconMessage.const_1003:
               ...
               {
                  case RoomWidgetSetToolbarIconMessage.const_1248:
                     break;
                  default:
                     Logger.log("MeMenuWidgetHandler: unknown icon widget type: " + _loc4_.widgetType);
               }
               break;
            case RoomWidgetNavigateToRoomMessage.const_950:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_655:
               if(_container != null)
               {
                  _container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetToolbarMessage.const_535:
               ...
               if(var_194)
               {
                  var_194.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_49,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(var_11 != null)
                  {
                     _loc12_ = false;
                     if(_container != null && false)
            ...
            case RoomWidgetToolbarMessage.const_570:
               ...
               if(var_194 && false)
               {
                  var_194.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_478,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_324:
               ...
               break;
            case RoomWidgetGetSettingsMessage.const_735:
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_360,_container.soundManager.volume));
               break;
            ...
            case RoomWidgetAvatarEditorMessage.const_615:
               if(false && _container.habboHelp.events)
               {
                  _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_396));
               }
               break;
            case RoomWidgetClothingChangeMessage.const_353:
               _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_699));
               break;
            default:
