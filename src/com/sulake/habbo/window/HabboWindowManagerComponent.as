package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private var var_710:ISkinContainer;
      ...
      private var var_1351:ProfilerAgentTask;
      
      private var var_1352:IEventDispatcher;
      
      private var var_2451:uint = 0;
      
      private var var_1354:ProfilerAgentTask;
      
      private var var_1353:ProfilerOutput;
      
      private var var_752:IWindowRenderer;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         var_710 = new SkinContainer(_loc3_.content as XML,assets);
         var_752 = new WindowRenderer(var_710);
         var_240 = new Array(const_374);
         var _loc5_:int = 0;
         while(_loc5_ < const_374)
         {
            _loc4_ = new WindowContext("layer_" + _loc5_,var_752,this,_localization,context.displayObjectContainer,new Rectangle(0,0,context.displayObjectContainer.stage.stageWidth,context.displayObjectContainer.stage.stageHeight),this);
            var_240[_loc5_] = _loc4_;
            _loc5_++;
         }
         var_229 = var_240[const_1138];
         ...
         var_229.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1331,_loc6_);
      }
      ...
      {
         return var_240[param1].getDesktopWindow().getChildAt(var_229.getDesktopWindow().numChildren - 1);
      }
      
      public function getLayoutByTypeAndStyle(param1:uint, param2:uint) : XML
      {
         var _loc3_:Dictionary = var_437[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? var_437[0][param1] as XML : _loc4_;
      }
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(var_1353 == null)
         {
            ...
            if(_loc3_ != null)
            {
               var_1353 = new ProfilerOutput(_loc3_,this,var_752);
               var_1351 = new ProfilerAgentTask("Update","Event processing");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1351);
               var_1354 = new ProfilerAgentTask("Redraw","Window rasterizer");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1354);
               var_1094 = true;
            }
         }
      }
      ...
      {
         return var_710.getDefaultAttributesByTypeAndStyle(param1,param2);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_972.length > 0)
         {
         ...
         if(WindowContext.var_972.length > 0)
         {
            WindowContext.var_972.flush();
         }
         if(WindowContext.var_1425.length > 0)
         {
            WindowContext.var_1425.flush();
         }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ...
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1270,param2.name + ": " + param2.toString());
            }
         }
      }
   }
