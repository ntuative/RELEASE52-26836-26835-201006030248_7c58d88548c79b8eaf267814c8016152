package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IAvatarImageListener
   {
      ...
      private var var_294:PetsGridItem;
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IAvatarRenderManager)
      {
         ...
         var_526 = _view.findChildByName("grid") as IItemGridWindow;
      ...
      private function selectFirst() : void
      {
         ...
         setSelectedGridItem(var_565.getWithIndex(0));
      }
      ...
      public function setSelectedGridItem(param1:PetsGridItem) : void
      {
         if(var_294 != null)
         {
            var_294.setSelected(false);
         }
         var_294 = param1;
         if(var_294 != null)
         {
            var_294.setSelected(true);
         }
      ...
      private function placeButtonClickHandler(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:PetData = var_294.pet;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:PetsGridItem = var_565.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         var_526.removeGridItem(_loc2_.window);
         if(var_294 == _loc2_)
         {
            var_294 = null;
            selectFirst();
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(var_565.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            var_526.addGridItem(_loc2_.window);
            var_565.add(param1.id,_loc2_);
            if(var_294 == null)
            {
               selectFirst();
            }
      ...
      private function updatePreview(param1:PetsGridItem = null) : void
      {
         ...
         {
            _loc12_ = param1.pet;
            _loc13_ = _avatarRenderer.createPetImageFromFigure(_loc12_.figure,AvatarScaleType.const_58,this);
            if(_loc13_ == null)
            {
               return;
            }
