package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_812:uint = 4284532064;
      
      private static const const_811:uint = 2577770;
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc4_.category == FurniCategory.const_985)
            {
            ...
            var_375.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_385);
            var_375.show();
         }
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         if(var_1625 == null)
         {
            var_1625 = createMinimizedWindow();
         }
         if(!var_2229)
         {
            return var_66;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(var_66)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !true ? uint(const_812) : uint(const_811);
            }
