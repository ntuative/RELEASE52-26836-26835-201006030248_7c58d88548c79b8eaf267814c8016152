package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_2347:BitmapData;
      
      protected var var_984:Boolean;
      
      protected var var_2338:Boolean;
      
      protected var var_2228:int;
      
      protected var _mainCategory:String;
      
      protected var var_466:int = 0;
      ...
      private const const_1461:Number = 0.2;
      
      protected var var_1436:Boolean;
      
      private const const_1462:Number = 1;
      ...
      public function addLocksFromData(param1:Array) : void
      {
         ...
         {
            _loc3_ = _items.getWithIndex(_loc2_);
            if(param1.indexOf(_loc3_.method_2) >= 0)
            {
               _loc3_.locked = true;
            }
            else
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(category == FurniCategory.const_754)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < _items.length)
      ...
      public function initImage() : void
      {
         ...
         {
            _loc1_ = _roomEngine.getFurnitureIcon(_type,this,String(var_1528));
         }
         else
         {
            _loc1_ = _roomEngine.getWallItemIcon(_type,this,var_1440);
         }
         if(_loc1_.id > 0)
         {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               _window.blend = const_1461;
               _loc1_.blend = const_1461;
            }
            else
            {
               _window.blend = const_1462;
               _loc1_.blend = const_1462;
            }
         }
         if(isSelected)
         {
         ...
         if(_loc5_)
         {
            if(var_1436 && getRecyclableCount() > 0)
            {
               _loc5_.bitmap = var_2347;
               _loc5_.visible = true;
            }
            else
            {
