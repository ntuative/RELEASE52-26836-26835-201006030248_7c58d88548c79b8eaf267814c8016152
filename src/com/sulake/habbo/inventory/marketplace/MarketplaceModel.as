package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceModel implements IInventoryModel
   {
      ...
      public function makeOffer(param1:int) : void
      {
         ...
         _loc2_.send(new MakeOfferMessageComposer(param1,_loc3_,var_239.method_2));
         releaseItem();
      }
      ...
      public function proceedOfferMaking(param1:int, param2:int) : void
      {
         ...
         switch(param1)
         {
            ...
            case 3:
               ...
               break;
            case 4:
               _view.showBuyTokens(var_1605,var_1604);
         }
      }
      ...
      {
         if(param1 != var_2140 || param2 != var_2139)
         {
            return;
         }
         if(!_view)
         ...
         _view.updateAveragePrice(param3,var_2122);
      }
