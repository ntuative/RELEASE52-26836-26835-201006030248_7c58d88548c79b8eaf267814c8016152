package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_844:IRoomSession;
      ...
      private const const_1719:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(var_18 != null)
         {
            ...
            var_18.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_390,roomSessionEventHandler);
      ...
      {
         return EffectsModel(var_47.getValue(InventoryCategory.const_590));
      }
      ...
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_905));
      }
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(const_1719);
         }
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(var_47.getValue(InventoryCategory.const_305));
      }
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = var_843.indexOf(param1);
            if(_loc3_ >= 0)
            {
               var_843.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         return TradingModel(var_47.getValue(InventorySubCategory.const_269));
      }
      
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         var_377 = ISessionDataManager(param2);
         queueInterface(new IIDHabboConfigurationManager(),onConfigurationManagerReady);
      }
      
      public function isInventoryCategoryInit(param1:String) : Boolean
      {
         if(var_843.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      {
         return var_47.getValue(InventoryCategory.const_328) as MarketplaceModel;
      }
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1027 = new IncomingMessages(this);
      ...
      {
         return BadgesModel(var_47.getValue(InventoryCategory.const_254));
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_18.events.addEventListener(RoomSessionPropertyUpdateEvent.const_390,roomSessionEventHandler);
         ...
         var_47.add(InventoryCategory.const_328,_loc3_);
         ...
         var _loc5_:BadgesModel = new BadgesModel(this,_windowManager,_communication,_assetLibrary,_localization,var_377);
         var_47.add(InventoryCategory.const_254,_loc5_);
         var _loc6_:EffectsModel = new EffectsModel(this,_windowManager,_communication,_assetLibrary,_localization);
         var_47.add(InventoryCategory.const_590,_loc6_);
         var _loc7_:AchievementsModel = new AchievementsModel(this,_windowManager,_communication,_assetLibrary,_localization,var_377);
         var_47.add(InventoryCategory.const_305,_loc7_);
         var _loc8_:TradingModel = new TradingModel(this,_windowManager,_communication,_assetLibrary,_roomEngine,_localization);
         var_47.add(InventorySubCategory.const_269,_loc8_);
