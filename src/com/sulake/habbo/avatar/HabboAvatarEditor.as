package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private static const const_1094:String = "hr-100.hd-180-7.ch-215-66.lg-270-79.sh-305-62.ha-1002-70.wa-2007";
      
      private static const const_1093:String = "hr-515-33.hd-600-1.ch-635-70.lg-716-66-62.sh-735-68";
      ...
      private var var_604:ISessionDataManager;
      ...
      private const const_1095:int = 2;
      ...
      private var var_1041:IHabboAvatarEditorDataSaver = null;
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return var_714.getSetType(param1);
      }
      ...
      private function init() : void
      {
         ...
         if(!var_169)
         {
            ...
            var_500["null"] = new FigureData(this);
            var_500["null"] = new FigureData(this);
            _loc1_ = var_500["null"];
            _loc2_ = var_500["null"];
            _loc1_.loadAvatarData(const_1094,FigureData.const_74);
            _loc2_.loadAvatarData(const_1093,FigureData.const_76);
            var_91 = new Map();
            var_404 = new Map();
            var_91.add(AvatarEditorFigureCategory.const_705,new BodyModel(this));
            var_91.add(AvatarEditorFigureCategory.const_46,new HeadModel(this));
            var_91.add(AvatarEditorFigureCategory.const_238,new TorsoModel(this));
            var_91.add(AvatarEditorFigureCategory.const_646,new LegsModel(this));
            var_91.add(AvatarEditorFigureCategory.HOTLOOKS,new HotLooksModel(this));
            var_404.add(AvatarEditorSideCategory.const_94,new WardrobeModel(this));
            var_404.add(AvatarEditorSideCategory.const_503,new ClubPromoModel(this));
            var_169 = true;
         }
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_604 = param2 as ISessionDataManager;
      }
      ...
      public function saveCurrentSelection() : void
      {
         ...
         if(var_1041 != null)
         {
            ...
            _loc2_ = "null";
            var_1041.saveFigure(_loc1_,_loc2_);
         }
      }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && var_1040 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc13_ = isClubTryoutAllowed() && var_1534;
            for each(_loc14_ in _loc10_.colors)
            {
               if(_loc14_.isSelectable && (_loc13_ || var_1040 >= _loc14_.clubLevel))
               {
                  _loc16_ = 0;
                  while(_loc16_ < const_1095)
                  {
                     _loc17_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1662.clone() as IWindowContainer,param1,_loc14_);
            ...
            if(_loc9_)
            {
               ...
               if(_loc19_)
               {
                  ...
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1426.clone() as IWindowContainer,param1,null,null,false);
            ...
            {
               _loc21_ = false;
               if(_loc6_.gender == FigureData.const_1362)
               {
                  _loc21_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc21_ && (_loc13_ || var_1040 >= _loc6_.clubLevel))
               {
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1426.clone() as IWindowContainer,param1,_loc6_,_loc12_,_loc15_);
                  _loc3_.push(_loc7_);
               }
            }
         }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return var_404.getValue(AvatarEditorSideCategory.const_94);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return var_714.getPalette(param1);
      }
      ...
      {
         var _loc2_:ISideContentModel = var_404.getValue(param1) as ISideContentModel;
         if(_loc2_ != null)
         {
      ...
      public function openEditor(param1:IWindowContainer = null, param2:IHabboAvatarEditorDataSaver = null, param3:Array = null, param4:Boolean = false) : Boolean
      {
         ...
         else
         {
            if(var_229 == null)
            {
               var_229 = _windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_59,HabboWindowStyle.const_43,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
         ...
         {
            toggleAvatarEditorPage(AvatarEditorFigureCategory.const_705);
         }
         var_1041 = param2;
         return true;
      }
      ...
      {
         var_714 = var_603.getFigureData(AvatarType.const_96);
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (var_603 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,onAvatarRendererReady);
      }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         var_1040 = param3;
         var _loc4_:FigureData = var_500[param2];
         if(_loc4_ == null)
         {
            return;
         }
