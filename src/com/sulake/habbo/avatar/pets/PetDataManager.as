package com.sulake.habbo.avatar.pets
{
   ...
   public class PetDataManager implements IPetDataManager
   {
      ...
      private const const_1735:int = 0;
      
      private var var_145:AvatarRenderManager;
      
      private const const_376:int = 2;
      ...
      public function init() : void
      {
         ...
         for each(_loc2_ in _loc1_)
         {
            if(_loc2_ != null)
            {
               ...
               var_532.add(_loc4_,new PetData(_loc3_));
            }
         }
      }
      ...
      private function onLoaderComplete(param1:Event) : void
      {
         ...
         var _loc3_:int = var_252.indexOf(_loc2_);
         if(_loc3_ >= 0)
         {
            var_252.splice(_loc3_,1);
         }
         if(false)
         {
            var_150 = const_376;
            var_145.resetPetData();
            notifyListeners();
         }
      }
      ...
      private function notifyListeners() : void
      {
         ...
         while(false)
         {
            _loc1_ = var_760.pop() as IPetDataListener;
            if(_loc1_ != null)
            {
               _loc1_.petDataReady();
            }
      ...
      {
         var _loc3_:IPetData = var_532.getValue(param1) as IPetData;
