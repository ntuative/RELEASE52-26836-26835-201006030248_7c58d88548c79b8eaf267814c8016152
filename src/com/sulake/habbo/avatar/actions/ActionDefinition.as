package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         var_2272 = parseInt(param1.@precedence);
         var_2271 = String(param1.@activepartset);
         var_2269 = String(param1.@assetpartdefinition);
         var_2273 = String(param1.@lay);
         var_657 = String(param1.@geometrytype);
         var_2116 = Boolean(parseInt(param1.@main));
         var_2267 = Boolean(parseInt(param1.@method_3));
         var_2268 = Boolean(parseInt(param1.@animation));
         var _loc2_:String = String(param1.@prevents);
         if(_loc2_ != "")
         {
            var_1187 = _loc2_.split(",");
         }
      ...
      {
         return var_1187.concat(getTypePrevents(param1));
      }
