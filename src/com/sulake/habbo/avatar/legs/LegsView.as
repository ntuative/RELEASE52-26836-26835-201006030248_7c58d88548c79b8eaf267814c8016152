   ...
   public class LegsView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_34)
         {
            ...
            var_34["null"] = new AvatarEditorGridView(_model,FigureData.const_194,_windowManager,_assetLibrary);
         ...
         if(_model && var_152 == "")
         {
            _model.switchCategory(FigureData.const_194);
         }
      }
