package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         _colorTransform = new ColorTransform(var_1639,var_1640,var_1638,_alphaMultiplier);
         var_1062 = generatePaletteMapForGrayscale(var_2062,var_2061);
      }
      
      public function get reds() : Array
      {
         return var_1062.getValue("reds") as Array;
      }
      ...
      {
         return var_1062.getValue("blues") as Array;
      }
      
      public function get greens() : Array
      {
         return var_1062.getValue("greens") as Array;
      }
      ...
      {
         return var_1062.getValue("alphas") as Array;
      }
