package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_176:IAssetLibrary;
      
      private var var_836:IAssetLibrary;
      
      private var var_1886:AvatarRenderManager;
      
      private var var_305:FigureData;
      ...
      private var var_1511:AvatarStructureDownloadSet;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         var_176 = param2;
         var_836 = param3;
         var_305 = new FigureData();
         var_398 = new PartSetsData();
         var_652 = new AnimationData();
         var_1511 = new AvatarStructureDownloadSet();
      ...
      {
         return var_835.getActionDefinitionWithState(param1);
      }
      ...
      public function init() : void
      {
         ...
         switch(var_698)
         {
            case AvatarType.const_96:
               _loc1_ = var_176.getAssetByName("HabboAvatarPartSets").content as XML;
               if(!var_398.parse(_loc1_))
               {
                  return;
               }
               _loc2_ = var_176.getAssetByName("HabboAvatarAnimation").content as XML;
               if(!var_652.parse(_loc2_))
               {
                  return;
               }
               _loc3_ = var_176.getAssetByName("HabboAvatarFigure").content as XML;
               if(!var_305.parse(_loc3_))
               {
                  return;
               }
               break;
            case AvatarType.PET:
               _loc1_ = var_176.getAssetByName("HabboAvatarPetPartSets").content as XML;
               if(!var_398.parse(_loc1_))
               {
                  return;
               }
               _loc2_ = var_176.getAssetByName("HabboAvatarPetAnimation").content as XML;
               if(!var_652.parse(_loc2_))
               {
                  return;
               }
               _loc3_ = var_176.getAssetByName("HabboAvatarPetFigure").content as XML;
               if(!var_305.parse(_loc3_))
               {
                  return;
               }
      ...
      {
         return var_835.getCanvasOffsets(param1,param2,param3);
      }
      
      public function injectFigureData(param1:XML) : void
      {
         var_305.injectXML(param1);
      }
      
      public function getActionDefinition(param1:String) : ActionDefinition
      {
         return var_835.getActionDefinition(param1);
      }
               ...
               if(_loc7_.hasAddData())
               {
                  ...
                  for each(_loc12_ in _loc7_.addData)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        _loc9_ = var_398.addPartDefinition(_loc11_);
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1416[param3];
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         var _loc8_:ActionDefinition = var_835.getDefaultAction();
         ...
         if(param3.definition.isAnimation)
         {
            ...
            _loc10_ = var_699.getAnimation(_loc19_);
            if(_loc10_ != null)
            {
         ...
         for each(_loc16_ in _loc15_)
         {
            ...
            _loc25_ = var_305.getSetType(_loc16_);
            if(_loc25_ != null)
            {
               _loc26_ = var_305.getPalette(_loc25_.paletteID);
               if(_loc26_)
               {
      ...
      private function onStructureReady(param1:Event = null) : void
      {
         ...
         if(var_698 == AvatarType.const_96)
         {
      ...
      private function initGeometry() : void
      {
         ...
         {
            case AvatarType.const_96:
               if(var_176.hasAsset("HabboAvatarGeometry"))
               {
                  _loc1_ = var_176.getAssetByName("HabboAvatarGeometry").content as XML;
               ...
               break;
            case AvatarType.PET:
               if(var_176.hasAsset("HabboAvatarPetGeometry"))
               {
                  _loc1_ = var_176.getAssetByName("HabboAvatarPetGeometry").content as XML;
                  _geometry = new AvatarModelGeometry(_loc1_);
               }
               else
               {
      ...
      public function initConfiguration(param1:IHabboConfigurationManager) : void
      {
         ...
         {
            case AvatarType.const_96:
               if(var_176.hasAsset(_loc5_))
               {
                  var_176.removeAsset(var_176.getAssetByName(_loc5_));
               }
               var_1511.add(new AvatarStructureDownload(var_176,_loc5_,var_305));
               break;
            case AvatarType.PET:
         }
         var_1511.addEventListener(AvatarStructureDownloadSet.DOWNLOAD_SET_DONE,onStructureReady);
      }
      ...
      {
         var_835 = new AvatarActionManager(var_176,var_698);
      }
      ...
      public function getMandatorySetTypeIds() : Array
      {
         ...
         var_1233 = var_305.getMandatorySetTypeIds();
         return var_1233;
      }
      
      public function getDefaultPartSet(param1:String, param2:String) : IFigurePartSet
      {
         return var_305.getDefaultPartSet(param1,param2);
      }
      ...
      private function registerAnimations() : void
      {
         var _loc2_:* = null;
         var _loc1_:int = 1;
         while(var_836.hasAsset("dance" + _loc1_))
         {
            _loc2_ = var_836.getAssetByName("dance" + _loc1_).content as XML;
            var_699.registerAnimation(this,_loc2_);
            _loc1_++;
         }
         _loc1_ = 1;
         while(var_836.hasAsset("fx" + _loc1_))
         {
            _loc2_ = var_836.getAssetByName("fx" + _loc1_).content as XML;
            var_699.registerAnimation(this,_loc2_);
            _loc1_++;
         }
      }
      ...
      public function getPartColor(param1:AvatarFigureContainer, param2:String, param3:int = 0) : IPartColor
      {
         ...
         var _loc5_:ISetType = var_305.getSetType(param2);
         if(_loc5_ == null)
         {
            return null;
         }
         var _loc6_:IPalette = var_305.getPalette(_loc5_.paletteID);
         if(!_loc6_)
         {
            return null;
         }
      ...
      {
         var_1510.loadOffsets(var_836);
      }
      
      public function sortActions(param1:Array) : Array
      {
         return var_835.sortActions(param1);
      }
   }
}
