package com.sulake.habbo.avatar.figuredata
{
   ...
   public class FigureDataView
   {
      ...
      public function FigureDataView(param1:IHabboWindowManager, param2:IAssetLibrary)
      {
         ...
         if(_loc4_)
         {
            var_1038 = _loc4_.content as BitmapData;
         }
         if(_window != null)
         {
            var_358 = _window.findChildByName("bitmap") as IBitmapWrapperWindow;
         }
      }
      ...
      public function udpate(param1:BitmapData) : void
      {
         if(var_358 && var_1038)
         {
            var_358.bitmap = new BitmapData(var_358.width,var_358.height,true,16777215);
            var_358.bitmap.copyPixels(var_1038,var_1038.rect,new Point(0,0 - 0 - 8));
            var_358.bitmap.copyPixels(param1,param1.rect,new Point(4,0),null,null,true);
         }
      }
   }
}
