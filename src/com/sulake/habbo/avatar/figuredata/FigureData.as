package com.sulake.habbo.avatar.figuredata
{
   ...
   public class FigureData
   {
      ...
      public static const const_1362:String = "U";
      ...
      private function updateView() : void
      {
         ...
         var _loc2_:IAvatarImage = var_29.avatarRenderManager.createAvatarImage(_loc1_,AvatarScaleType.const_58,gender);
         if(_loc2_)
         {
            _loc2_.setDirection(AvatarSetType.const_38,int(const_767));
