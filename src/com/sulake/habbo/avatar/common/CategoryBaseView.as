   ...
   public class CategoryBaseView
   {
      ...
      protected function setElementImage(param1:IBitmapWrapperWindow, param2:Boolean) : void
      {
         ...
         if(result && result.length)
         {
            ...
            {
               bmpWindow.bitmap = new BitmapData(bmpWindow.width,bmpWindow.height,false,AvatarEditorView.var_2326);
      ...
      protected function method_1(param1:String) : void
      {
         if(!_window)
         {
            return;
      ...
      protected function updateGridView() : void
      {
         ...
         var _loc2_:AvatarEditorGridView = var_34[var_152];
         if(_loc2_ == null)
         {
            return;
         }
