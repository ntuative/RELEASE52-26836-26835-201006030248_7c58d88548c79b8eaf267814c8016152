package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryData
   {
      ...
      public function selectPartIndex(param1:int) : AvatarEditorGridPartItem
      {
         ...
         if(var_674 >= 0 && var_171.length > var_674)
         {
            _loc2_ = var_171[var_674];
            if(_loc2_)
            {
      ...
      public function getSelectedColorIds() : Array
      {
         ...
         while(_loc5_ < var_191.length)
         {
            ...
            {
               if(_loc7_.length > var_191[_loc5_])
               {
      ...
      public function selectColorIndex(param1:int, param2:int) : AvatarEditorGridColorItem
      {
         ...
         deselectColorIndex(var_191[param2],param2);
         var_191[param2] = param1;
      ...
      public function getSelectedColor(param1:int) : AvatarEditorGridColorItem
      {
         ...
         if(!_loc2_ || _loc2_.length <= var_191[param1])
         {
            return null;
         }
      ...
      {
         return var_171[var_674] as AvatarEditorGridPartItem;
      }
      ...
      public function selectColorIds(param1:Array) : void
      {
         ...
         var_191 = new Array(param1.length);
         var _loc3_:int = 0;
