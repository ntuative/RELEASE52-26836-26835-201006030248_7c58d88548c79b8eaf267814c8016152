package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private var var_755:IPartColor;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(var_754.width,var_754.height,true,0);
            _loc1_.bitmap.copyPixels(var_754,var_754.rect,new Point(0,0));
         }
         var _loc2_:IBitmapWrapperWindow = _window.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(var_919.width,var_919.height,true,0);
            _loc5_ = var_919.clone();
            _loc5_.colorTransform(_loc5_.rect,var_755.colorTransform);
            ...
            if(var_755)
            {
               switch(var_755.clubLevel)
               {
                  ...
                  case HabboClubLevelEnum.const_54:
                     _loc4_.style = HabboIconType.const_604;
                     _loc4_.visible = true;
               }
            }
            else
