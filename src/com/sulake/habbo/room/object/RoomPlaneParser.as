package com.sulake.habbo.room.object
{
   ...
   public class RoomPlaneParser
   {
      ...
      private var var_1369:Number = 0.0;
      ...
      private var var_933:Number = 0.0;
      ...
      public function getPlaneType(param1:int) : int
      {
         ...
         {
            return RoomPlaneData.const_945;
         }
      ...
      {
         var _loc11_:* = null;
         addPlane(RoomPlaneData.const_157,param1,param2,param3,[param4]);
         addPlane(RoomPlaneData.const_294,param1,param2,param3,[param4]);
         var _loc9_:Vector3d = Vector3d.crossProduct(param2,param3);
         var _loc10_:Vector3d = Vector3d.product(_loc9_,1 / _loc9_.length * -var_933);
         addPlane(RoomPlaneData.const_157,Vector3d.sum(param1,param3),param2,_loc10_,[_loc9_,param4]);
         if(param5)
         {
            addPlane(RoomPlaneData.const_157,Vector3d.sum(Vector3d.sum(param1,param2),param3),Vector3d.product(param3,-(param3.length + _floorThickness) / param3.length),_loc10_,[_loc9_,param4]);
         }
         if(param6)
         {
            addPlane(RoomPlaneData.const_157,Vector3d.sum(param1,Vector3d.product(param3,-_floorThickness / param3.length)),Vector3d.product(param3,(param3.length + _floorThickness) / param3.length),_loc10_,[_loc9_,param4]);
            if(param7)
            {
               _loc11_ = Vector3d.product(param2,var_933 / param2.length);
               addPlane(RoomPlaneData.const_157,Vector3d.sum(Vector3d.sum(param1,param3),Vector3d.product(_loc11_,-1)),_loc11_,_loc10_,[_loc9_,param2,param4]);
            }
         }
      }
      ...
      private function createWallPlanes() : Boolean
      {
         ...
         var _loc10_:Array = [extractTopWall,extractRightWall,method_9,extractLeftWall];
         var _loc11_:int = 0;
      ...
      public function initializeFromTileData(param1:Boolean = false) : Boolean
      {
         ...
         var_773 = getFloorHeight(var_111);
         if(!param1)
         {
            createWallPlanes();
         }
      ...
      private function method_9(param1:Point) : Point
      {
         if(param1 == null)
         {
            return null;
      ...
      public function setTileHeight(param1:int, param2:int, param3:Number) : Boolean
      {
         ...
         if(param1 >= 0 && param1 < _width && param2 >= 0 && param2 < _height)
         {
            ...
            {
               if(param1 == var_372 || param1 == var_374)
               {
                  _loc5_ = false;
                  _loc6_ = var_371;
                  while(_loc6_ < var_373)
                  {
               ...
               if(param2 == var_371 || param2 == var_373)
               {
                  _loc7_ = false;
                  _loc8_ = var_372;
                  while(_loc8_ < var_374)
                  {
      ...
      {
         var _loc12_:RoomPlaneData = addPlane(RoomPlaneData.const_182,param1,param2,param3);
         ...
         if(_loc12_)
         {
            ...
            if(param6)
            {
               ...
               _loc14_ = addPlane(RoomPlaneData.const_182,_loc13_,new Vector3d(0,0,-_floorThickness),param2);
               if(_loc14_ != null)
               {
                  if(param8 > 0)
                  {
            ...
            if(param7)
            {
               ...
               _loc14_ = addPlane(RoomPlaneData.const_182,_loc13_,new Vector3d(0,0,-_floorThickness),Vector3d.product(param2,-1));
               if(_loc14_ != null)
               {
                  if(param9 > 0)
                  {
            ...
            if(param4)
            {
               ...
               _loc15_ = addPlane(RoomPlaneData.const_182,_loc13_,new Vector3d(0,0,-_floorThickness),Vector3d.product(param3,-1));
               if(_loc15_ != null)
               {
                  if(param11 > 0)
                  {
            ...
            if(param5)
            {
               ...
               _loc15_ = addPlane(RoomPlaneData.const_182,_loc13_,new Vector3d(0,0,-_floorThickness),param3);
               if(_loc15_ != null)
               {
                  if(param10 > 0)
                  {
