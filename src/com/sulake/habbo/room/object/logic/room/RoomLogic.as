package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_840,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_684,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_695,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_644,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_546,1);
         }
      }
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_837,int(param1.bgOnly));
         var_1281 = _color;
         var_1560 = var_1311;
         var_1053 = _loc3_;
         var_1561 = _loc4_;
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1038:
               param2.setNumber(RoomObjectVariableEnum.const_695,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_842:
               param2.setNumber(RoomObjectVariableEnum.const_644,_loc3_);
               param2.setNumber(RoomObjectVariableEnum.const_546,_loc3_);
         }
      }
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_479:
               ...
               var_394.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_565:
               _loc4_ = var_394.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = var_394.getXML();
            _loc7_ = _loc6_.toXMLString();
            param2.setString(RoomObjectVariableEnum.const_871,_loc7_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_592:
               param2.setString(RoomObjectVariableEnum.const_710,param1.value);
               break;
            ...
            case RoomObjectRoomUpdateMessage.const_537:
               param2.setString(RoomObjectVariableEnum.const_764,param1.value);
         }
      }
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(var_869)
         {
            ...
            else
            {
               ...
               _loc9_ = var_1281 & 255;
               _loc10_ = var_1053 >> 16 & 255;
               _loc11_ = var_1053 >> 8 & 255;
               _loc12_ = var_1053 & 255;
               _loc13_ = (_loc2_ - var_869) / var_1559;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = var_1560 + (var_1561 - var_1560) * _loc13_;
               _color = _loc3_;
               var_1311 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_684,_loc3_);
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1196,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1392,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1310,_loc22_);
            ...
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc13_ == RoomPlaneData.const_157 || _loc13_ == RoomPlaneData.const_294)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
