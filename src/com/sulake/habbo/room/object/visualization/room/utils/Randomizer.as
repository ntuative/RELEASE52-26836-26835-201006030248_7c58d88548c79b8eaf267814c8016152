package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      private var var_2417:int = 69069;
      
      private var var_1260:int = 1;
      
      private var var_2418:int = 5;
      
      private var var_1541:int = 16777216;
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / var_1541 * param2);
      }
      ...
      {
         var _loc1_:int = var_2417 * var_1260 + var_2418;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
