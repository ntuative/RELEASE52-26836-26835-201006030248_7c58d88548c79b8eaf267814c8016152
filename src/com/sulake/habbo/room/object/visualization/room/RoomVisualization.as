package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1265:int = 13421772;
      
      private static const const_781:int = 16777215;
      
      public static const const_1398:int = 10066329;
      
      private static const const_780:int = 13421772;
      
      public static const const_1346:int = 16777215;
      
      public static const const_1247:int = 16777215;
      
      private static const const_779:int = 10066329;
      
      private static const const_778:int = 10066329;
      ...
      private var var_1335:String = null;
      
      private var var_1799:int = 255;
      ...
      private var var_1336:String = null;
      
      private var var_1713:int = -1000;
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         while(_loc7_ < var_85.planeCount)
         {
            ...
            else if(_loc12_ == RoomPlaneData.const_1372)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_114,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_871);
            if(_loc3_ != var_1793)
            {
            ...
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_684));
            if(_loc4_ != var_1014)
            {
               var_1014 = _loc4_;
               var_1798 = var_1014 & 255;
               var_1795 = var_1014 >> 8 & 255;
               var_1799 = var_1014 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_837));
            if(_loc5_ != var_1478)
            {
               var_1478 = _loc5_;
               _loc2_ = true;
      ...
      override public function get boundingRectangle() : Rectangle
      {
         if(var_586 == null)
         {
            var_586 = super.boundingRectangle;
         }
         return new Rectangle(var_586.x,var_586.y,var_586.width,var_586.height);
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         var _loc8_:int = 0;
         while(_loc8_ < var_394.maskCount)
         {
            _loc10_ = var_394.getMaskType(_loc8_);
            _loc11_ = var_394.getMaskLocation(_loc8_);
            _loc12_ = var_394.getMaskCategory(_loc8_);
            if(_loc11_ != null)
            {
               _loc13_ = 0;
               while(_loc13_ < var_110.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_114 || _loc3_.type == RoomPlane.const_91)
                  {
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_114 || _loc3_.type == RoomPlane.const_91 && _loc12_ == RoomPlaneBitmapMaskData.const_225)
                              {
      ...
      {
         if(param1 != var_299["null"] || param2 != var_299["null"] || param3 != var_299["null"])
         {
            var_299["null"] = param1;
            var_299["null"] = param2;
            var_299["null"] = param3;
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         if(_loc7_ < var_1713 + const_1716 && !_loc4_ && !_loc6_)
         {
            return;
         }
         ...
         var _loc8_:int = 0;
         while(_loc8_ < var_195.length)
         {
            _loc9_ = 0;
            _loc10_ = getSprite(_loc9_);
            _loc11_ = var_195[_loc8_] as RoomPlane;
            if(_loc10_ != null && _loc11_ != null && _loc11_.type != RoomPlane.const_91)
            {
               if(var_1478)
               {
                  _loc12_ = uint(_loc11_.color);
                  _loc13_ = uint((_loc12_ & 255) * var_1798 / 255);
                  _loc14_ = uint((_loc12_ >> 8 & 255) * var_1795 / 255);
                  _loc15_ = uint((_loc12_ >> 16 & 255) * var_1799 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != var_1292)
         {
            ...
            if(_loc3_ != null && (_loc3_.x != var_1059 || _loc3_.y != var_1800 || _loc3_.z != var_1796 || param1.scale != var_1797))
            {
               var_1059 = _loc3_.x;
               var_1800 = _loc3_.y;
               var_1796 = _loc3_.z;
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : void
      {
         ...
         if(var_166 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_557);
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_710);
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_764);
            updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_695));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_644));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_546));
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + var_1479;
      }
