package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_808:int = 15;
      
      private static const const_1139:int = 2;
      
      private static const const_371:int = 2;
      
      private static const const_809:int = 31;
      ...
      private function getNewPoint(param1:int, param2:Number) : Point
      {
         ...
         var_1100[param1] = _loc3_;
         if(int(_loc9_) == 0)
         {
            var_1101[param1] = getRandomAmplitudeFactor();
         }
      ...
      private function initItems(param1:Number) : void
      {
         ...
         var_1100 = new Array();
         var_1100.push(Math.random() * _loc2_ * 1.5);
         var_1100.push(Math.random() * _loc2_ * 1.5);
         var_1099 = new Array();
         var_1099.push(1);
         var_1099.push(-1);
         var_1098 = new Array();
         var_1098.push(const_1139);
         var_1098.push(const_1140);
         var_1101 = new Array();
         var_1101.push(getRandomAmplitudeFactor());
         var_1101.push(getRandomAmplitudeFactor());
      }
