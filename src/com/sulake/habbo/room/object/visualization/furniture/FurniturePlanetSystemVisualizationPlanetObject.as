package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualizationPlanetObject
   {
      ...
      private static const const_1081:Number = 30;
      ...
      private var var_694:Vector3d;
      
      private var var_1163:Number;
      ...
      {
         var_694 = new Vector3d(0,0,0);
         _children = new Array();
         super();
         _name = param1;
         _index = param2;
         var_1163 = param3;
         var_1827 = param4 * 0 * 2 / 360;
         var_1491 = param5 * 0 * 2 / 360;
         _height = param6;
         var_829 = 0;
      }
      ...
      {
         var _loc3_:Number = var_1163 * Math.cos(var_829 + var_1491);
         var _loc4_:Number = var_1163 * Math.sin(var_829 + var_1491);
         var _loc5_:Number = _height;
         var_694.x = (_loc3_ - _loc4_) * (param2 / 2);
         var_694.y = (_loc4_ + _loc3_) * (param2 / 2) * 0.5 - _height * (param2 / 2);
         var_694.z = -int(4 * (_loc3_ + _loc4_) - 0.7);
         if(param1 != null)
         {
            var_694.add(param1);
         }
