   ...
   public class FurniturePlane
   {
      ...
      public function setRotation(param1:Boolean) : void
      {
         if(param1 != var_2054)
         {
            if(!param1)
            {
               var_269.assign(var_613);
               var_270.assign(var_612);
            }
            else
            {
               var_269.assign(var_613);
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc9_:* = null;
         if(param1 == null || var_75 == null && var_876 != null || var_269 == null || var_270 == null || var_513 == null)
         {
            return false;
         }
         ...
         if(param1.updateId != var_1292)
         {
            ...
            if(_loc4_ != null && (_loc4_.x != var_1059 || _loc4_.y != var_1800 || _loc4_.z != var_1796 || param1.scale != var_1797))
            {
               var_1059 = _loc4_.x;
               var_1800 = _loc4_.y;
               var_1796 = _loc4_.z;
