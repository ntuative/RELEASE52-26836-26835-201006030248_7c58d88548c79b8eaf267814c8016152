package com.sulake.habbo.room.object.visualization.furniture.data
{
   ...
   public class SizeData
   {
      ...
      private var var_1319:int = 360;
      
      private var var_2087:int = 0;
      
      private var var_739:DirectionData = null;
      ...
      public function getDirectionValue(param1:int) : int
      {
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc2_:int = (param1 % 360 + 360 + var_1319 / 2) % 360 / var_1319;
         ...
         {
            _loc6_ = int(var_233.getKey(_loc5_)) * var_1319;
      ...
      private function defineDirection(param1:DirectionData, param2:XMLList) : Boolean
      {
         ...
         },_loc5_++)
         {
            ...
            {
               case "ADD":
                  param1.method_5(_loc7_,LayerData.const_966);
                  break;
               case "SUBTRACT":
                  param1.method_5(_loc7_,LayerData.const_870);
                  break;
               case "DARKEN":
                  param1.method_5(_loc7_,LayerData.INK_DARKEN);
                  break;
            }
         }
         return true;
