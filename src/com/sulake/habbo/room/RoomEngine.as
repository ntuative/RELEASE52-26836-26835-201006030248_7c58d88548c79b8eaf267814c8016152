package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_796:String = "overlay";
      
      private static const OBJECT_TYPE_SELECTION_ARROW:String = "selection_arrow";
      
      private static const const_1092:String = "tile_cursor";
      ...
      private var var_712:RoomMessageHandler = null;
      
      private var var_713:IRoomRendererFactory = null;
      ...
      public function RoomEngine(param1:IContext, param2:uint = 0)
      {
         ...
         var_712 = new RoomMessageHandler(this);
      ...
      public function deleteRoomObject(param1:int, param2:int) : Boolean
      {
         if(var_68 != null)
         {
            ...
            {
               return var_68.deleteWallItem(var_116,var_117,param1);
            }
         }
         return false;
      }
      ...
      private function updateRoomCameras(param1:uint) : void
      {
         ...
         var _loc49_:* = null;
         var _loc2_:int = 0;
         for(; _loc2_ < var_308.length; _loc2_++)
         {
            _loc3_ = var_308.getWithIndex(_loc2_) as RoomInstanceData;
            _loc4_ = null;
            _loc5_ = 0;
            _loc6_ = 0;
            if(_loc3_ != null)
               ...
               if(_loc8_ != null)
               {
                  ...
                  if(_loc11_ != null)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc15_ != null)
                        {
                           _loc16_ = _loc15_.getNumber(RoomVariableEnum.const_624) - 0.5;
                           _loc17_ = _loc15_.getNumber(RoomVariableEnum.const_740) - 0.5;
                           _loc18_ = _loc15_.getNumber(RoomVariableEnum.const_619) + 0.5;
                           _loc19_ = _loc15_.getNumber(RoomVariableEnum.const_742) + 0.5;
      ...
      public function modifyRoomObjectData(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_68 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_32)
            {
               return var_68.modifyWallItemData(var_116,var_117,param1,param3);
            }
         }
         return false;
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_388 != null)
         {
            var_388.release(new IIDRoomObjectVisualizationFactory());
            var_388 = null;
         }
         if(var_43 != null)
         {
         ...
         if(var_713 != null)
         {
            var_713.release(new IIDRoomRendererFactory());
            var_713 = null;
         }
         ...
         if(var_308 != null)
         {
            ...
            {
               _loc2_ = var_308.getWithIndex(_loc1_) as RoomInstanceData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         if(_loc9_ == null)
         {
            _loc9_ = var_713.createRenderer();
         }
         if(_loc9_ == null)
         {
            return null;
         }
         _loc9_.roomObjectVariableAccurateZ = RoomObjectVariableEnum.const_968;
         ...
         if(_loc10_.geometry != null)
         {
            ...
            _loc10_.geometry.z_scale = _loc8_.getNumber(RoomVariableEnum.const_672);
         }
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_544);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_675);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_929);
            _loc16_ = _loc8_.getNumber(RoomObjectVariableEnum.const_938);
         ...
         if(_loc7_ != null)
         {
            if(_loc7_.getModel() != null)
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1000) > 0)
               {
                  ...
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_565,_loc5_);
                  }
               }
            }
         }
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.ROOM_OBJECT_REMOVED,var_116,var_117,param2,param3));
            }
         }
      }
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_68 != null)
         {
            return var_68.modifyRoomObject(var_116,var_117,param1,param2,param3);
         }
         return false;
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         ...
         if(param5 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_537,param5);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         return true;
      }
      ...
      private function onRoomManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_43 != null)
         {
            ...
            var_43.addObjectUpdateCategory(RoomObjectCategoryEnum.const_39);
            var_43.addObjectUpdateCategory(RoomObjectCategoryEnum.const_268);
      ...
      private function roomObjectEventHandler(param1:RoomObjectEvent) : void
      {
         if(var_68 != null)
         {
            var_68.handleRoomObjectEvent(param1,var_116,var_117);
         }
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_12.sessionDataManager = var_377;
      }
      ...
      public function addObjectFurniture(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String, param9:Number = NaN, param10:int = -1) : Boolean
      {
         ...
         if(_loc14_ != null && _loc14_.getModelController() != null)
         {
            ...
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_916,1,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_911,param10);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_844,getTimer());
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_258,param1,param2,param3,RoomObjectCategoryEnum.const_34));
         }
      ...
      {
         if(var_27 == null || var_388 == null || var_43 == null || var_713 == null || _communication == null || _habboConfiguration == null || !var_1953)
         {
            return;
         }
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_299,RoomObjectCategoryEnum.const_68);
      }
      ...
      public function updateObjectRoomColor(param1:int, param2:int, param3:uint, param4:int, param5:Boolean) : Boolean
      {
         ...
         var _loc7_:* = null;
         _loc7_ = new RoomObjectRoomColorUpdateMessage(RoomObjectRoomColorUpdateMessage.const_1237,param3,param4,param5);
         _loc6_.getEventHandler().processUpdateMessage(_loc7_);
      ...
      public function update(param1:uint) : void
      {
         ...
         var _loc2_:IRoomInstance = var_43.getRoom(getRoomIdentifier(var_116,var_117));
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_797,RoomObjectCategoryEnum.const_268);
      }
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = getRoomCanvas(var_116,var_117,var_1256);
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = getRoomCanvas(var_116,var_117,var_1256);
         if(_loc1_ != null)
         {
      ...
      private function onVisualizationFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_388 = param2 as IRoomObjectVisualizationFactory;
         if(var_12 != null)
         {
            var_12.visualizationFactory = var_388;
         }
         initializeRoomManager();
      }
      ...
      private function initializeObjectEvents() : void
      {
         if(var_27 != null)
         {
            if(false)
            {
               var_27.events.addEventListener(RoomObjectMouseEvent.const_213,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectMouseEvent.const_510,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectMouseEvent.const_398,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectStateChangeEvent.const_163,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectStateChangeEvent.const_612,roomObjectEventHandler);
               ...
               var_27.events.addEventListener(RoomObjectWidgetRequestEvent.const_125,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectWidgetRequestEvent.const_102,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectWidgetRequestEvent.const_118,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectFurnitureActionEvent.const_489,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectFurnitureActionEvent.const_467,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectFurnitureActionEvent.const_482,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectFurnitureActionEvent.ROOM_OBJECT_STICKIE,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectFurnitureActionEvent.const_436,roomObjectEventHandler);
               ...
               var_27.events.addEventListener(RoomObjectFurnitureActionEvent.const_451,roomObjectEventHandler);
               ...
               var_27.events.addEventListener(RoomObjectMoveEvent.const_409,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectMoveEvent.const_491,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectRoomAdEvent.const_284,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectRoomAdEvent.const_378,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectRoomAdEvent.const_348,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectRoomAdEvent.const_309,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectRoomActionEvent.const_392,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectRoomActionEvent.const_990,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectRoomActionEvent.const_461,roomObjectEventHandler);
               var_27.events.addEventListener(AvatarWalkWarpingWarningEvent.const_475,warningEventHandler);
            }
         }
      }
      ...
      {
         var _loc5_:IRoomInstance = getRoom(var_116,var_117);
         if(_loc5_ == null || _loc5_.getNumber(RoomVariableEnum.const_714) != 0)
         {
            return false;
         }
         if(var_68 != null)
         {
            return var_68.initializeRoomObjectInsert(var_116,var_117,param1,param2,param3,param4);
         }
         return false;
      }
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_258,param1,param2,param3,RoomObjectCategoryEnum.const_39));
         }
         return true;
      }
      ...
      public function updateObjectRoomVisibilities(param1:int, param2:int, param3:Boolean, param4:Boolean = true) : Boolean
      {
         ...
         var _loc6_:* = null;
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_842,param3);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
            ...
            if(_loc14_ != null && _loc14_.getModel() != null)
            {
               ...
               switch(param4)
               {
                  ...
                  case RoomObjectCategoryEnum.const_32:
                     ...
                     _loc11_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_419);
                     break;
      ...
      {
         if(param1 != null && param1.type == RoomContentLoader.const_757)
         {
            var_1953 = true;
            initializeRoomManager();
         }
      ...
      public function addObjectWallItem(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String) : Boolean
      {
         ...
         if(_loc12_ != null && _loc12_.getModelController() != null)
         {
            ...
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_968,1,true);
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_258,param1,param2,param3,RoomObjectCategoryEnum.const_32));
         }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_263.events.addEventListener(AdEvent.const_492,showRoomAd);
      }
      ...
      private function getOverlaySprite(param1:IRoomRenderingCanvas) : Sprite
      {
         ...
         return _loc2_.getChildByName(const_796) as Sprite;
      }
      ...
      public function disposeRoom(param1:int, param2:int) : void
      {
         ...
         var _loc4_:RoomInstanceData = var_308.remove(_loc3_);
         if(_loc4_ != null)
         {
            _loc4_.dispose();
         }
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_734,param1,param2));
      }
      ...
      private function onRendererFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_713 = param2 as IRoomRendererFactory;
         initializeRoomManager();
      }
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:String = null, param7:uint = 0, param8:String = null) : ImageResult
      {
         ...
         switch(_loc12_)
         {
            ...
            case RoomObjectCategoryEnum.const_32:
               ...
               _loc13_.getModelController().setString(RoomObjectVariableEnum.const_419,param8);
               break;
            case RoomObjectCategoryEnum.const_39:
               _loc13_.getModelController().setString(RoomObjectVariableEnum.const_188,param2);
               break;
            case RoomObjectCategoryEnum.const_68:
               if(param2 != null)
               {
                  ...
                  if(_loc17_.length >= 3)
                  {
                     ...
                     _loc21_.addPlane(RoomPlaneData.const_294,new Vector3d(10,0,0),new Vector3d(-10,0,0),new Vector3d(0,0,10));
                     _loc22_ = _loc21_.getXML();
                     _loc13_.getEventHandler().initialize(_loc22_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_710,_loc18_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_557,_loc19_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_764,_loc20_);
                     if(param6 != null)
                     {
                        _loc23_ = null;
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_795,RoomObjectCategoryEnum.const_268);
      }
      ...
      public function handleRoomCanvasMouseEvent(param1:int, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var _loc9_:IRoomRenderingCanvas = getRoomCanvas(var_116,var_117,param1);
         if(_loc9_ != null)
         {
            var_1256 = param1;
            var_1531 = param2;
            ...
            if(_loc11_ != null)
            {
               ...
               _loc11_.x = var_1531 - _loc12_.width / 2;
               _loc11_.y = var_1530 - _loc12_.height / 2;
            }
            if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
            {
               ...
               if(param4 == MouseEvent.CLICK)
               {
                  if(events != null)
                  {
                     events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_483,var_116,var_117,-1,RoomObjectCategoryEnum.const_221));
                  }
                  _loc13_ = "null";
               }
               ...
               if(var_68 != null)
               {
                  _loc14_ = new RoomObjectMouseEvent(_loc13_,const_299,const_521);
                  var_68.handleRoomObjectEvent(_loc14_,var_116,var_117);
               }
            }
         }
      }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         if(param3)
         {
            _loc6_ = getRoomObjectImage(var_116,var_117,param1,param2,new Vector3d(),1,null);
         }
         else if(var_12 != null)
         {
            _loc8_ = null;
         ...
         var _loc7_:IRoomRenderingCanvas = getRoomCanvas(var_116,var_117,var_1256);
         if(_loc7_ != null)
         {
            ...
            if(_loc11_ != null)
            {
               _loc11_.x = var_1531 - _loc6_.data.width / 2;
               _loc11_.y = var_1530 - _loc6_.data.height / 2;
            }
         }
      }
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(var_12 != null)
         {
            ...
            var_12.addGraphicAsset(var_12.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_351,param1.image,true);
            var_12.addGraphicAsset(var_12.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_897,param1.adWarningL,true);
            var_12.addGraphicAsset(var_12.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_926,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_859,RoomObjectVariableEnum.const_351,param1.clickUrl);
      ...
      {
         var _loc3_:String = getRoomIdentifier(param1,param2);
         var _loc4_:RoomInstanceData = var_308.getValue(_loc3_) as RoomInstanceData;
         if(_loc4_ == null)
         {
            _loc4_ = new RoomInstanceData(param1,param2);
            var_308.add(_loc3_,_loc4_);
         }
         return _loc4_;
      }
      ...
      private function onHabboConfigurationInit(param1:Event) : void
      {
         if(var_12 != null)
         {
            _events.addEventListener(RoomContentLoader.const_757,onContentLoaderReady);
      ...
      public function cancelRoomObjectInsert() : void
      {
         if(var_68 != null)
         {
            var_68.cancelRoomObjectInsert(var_116,var_117);
         }
      }
      ...
      {
         return getRoomObjectBoundingRectangle(var_116,var_117,const_299,RoomObjectCategoryEnum.const_68,param1);
      }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         if(isPublicRoomWorldType(param6))
         {
            ...
            _loc7_.setNumber(RoomVariableEnum.const_714,1,true);
            _loc13_ = parseInt(_habboConfiguration.getKey("ads.billboard.displayDelayMillis","1000"));
            _loc9_.getModelController().setNumber(RoomVariableEnum.const_936,_loc13_,true);
            if(var_12 != null)
            {
         ...
         {
            _loc9_ = _loc7_.createRoomObject(const_299,const_521,_loc8_) as IRoomObjectController;
            _loc7_.setNumber(RoomVariableEnum.const_714,0,true);
         }
         _loc7_.setNumber(RoomVariableEnum.const_672,_loc10_,true);
         if(param2 != null)
         {
            _loc14_ = 0;
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_624,_loc16_);
               _loc7_.setNumber(RoomVariableEnum.const_619,_loc17_);
               _loc7_.setNumber(RoomVariableEnum.const_740,_loc18_);
               _loc7_.setNumber(RoomVariableEnum.const_742,_loc19_);
         ...
         if(param5 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_537,param5);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param2 != null)
         {
            if(param2.doors.door.length() > 0)
            {
               ...
               while(_loc23_ < _loc20_.length())
               {
                  ...
                  if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                  {
                     ...
                     _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_479,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_225);
                     _loc9_.getEventHandler().processUpdateMessage(_loc22_);
                     if(_loc28_ == 90 || _loc28_ == 180)
                     {
                        if(_loc28_ == 90)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_544,_loc25_ - 0.5,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_675,_loc26_,true);
                        }
                        if(_loc28_ == 180)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_544,_loc25_,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_675,_loc26_ - 0.5,true);
                        }
                        _loc7_.setNumber(RoomObjectVariableEnum.const_929,_loc27_,true);
                        _loc7_.setNumber(RoomObjectVariableEnum.const_938,_loc28_,true);
                     }
                  }
                  _loc23_++;
               }
         ...
         _loc7_.createRoomObject(const_795,const_1092,RoomObjectCategoryEnum.const_268);
         _loc7_.createRoomObject(const_797,OBJECT_TYPE_SELECTION_ARROW,RoomObjectCategoryEnum.const_268);
         return _loc7_;
      }
