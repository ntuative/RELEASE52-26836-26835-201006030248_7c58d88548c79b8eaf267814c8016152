package com.sulake.habbo.session.furniture
{
   ...
   public class FurnitureDataParser extends EventDispatcher
   {
      ...
      private var var_778:AssetLibrary;
      ...
      public function FurnitureDataParser(param1:String, param2:Map, param3:Map, param4:Map, param5:ICoreLocalizationManager)
      {
         ...
         var_778 = new AssetLibrary("FurniDataParserAssetLib");
         var _loc6_:AssetLoaderStruct = var_778.loadAssetFromFile(param1,new URLRequest(param1),"text/plain");
