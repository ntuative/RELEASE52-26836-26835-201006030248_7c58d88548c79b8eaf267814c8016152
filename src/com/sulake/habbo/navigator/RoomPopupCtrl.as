package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         var_1680 = new RoomThumbnailRenderer(param1);
         var_832 = new TagRenderer(param1,hideInstantly);
      }
      
      private function refreshOwnerName() : void
      {
         refreshTextWithCaption("roomowner",var_182,var_120.ownerName);
      ...
      private function refreshExtraCont() : void
      {
         ...
         var_832.refreshTags(_loc1_,var_120.tags);
         refreshTextWithCaption("rating",_loc1_,"undefined");
         if(false)
         {
            refreshTextWithCaption("startedat",_loc1_,"undefined");
         }
         var_1680.refreshThumbnail(_loc1_,var_120.thumbnail,false);
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         refreshRoomName(var_182,var_120);
         if(true)
         {
         }
         refreshOwnerName();
         refreshTextWithCaption("roomctg",var_182,!true ? getEventCtg(var_120.categoryId) : getRoomCtg(var_120.categoryId));
         refreshRoomDesc(var_182,var_120);
         refreshExtraCont();
         refreshInfo(var_182,"trading_allowed",var_120.allowTrading);
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_223,Tabs.const_241,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
