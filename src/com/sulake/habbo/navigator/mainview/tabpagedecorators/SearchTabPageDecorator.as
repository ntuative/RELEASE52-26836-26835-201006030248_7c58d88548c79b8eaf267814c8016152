package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class SearchTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_1558:TextSearchInputs;
      ...
      private function onClearResultsClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _navigator.mainViewCtrl.startSearch(Tabs.const_223,Tabs.const_241,"-1",MainViewCtrl.const_759);
      }
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_1558 == null)
         {
            ...
            var_1558 = new TextSearchInputs(_navigator,false,_loc4_);
         ...
         {
            var_1558.searchStr.setText(_navigator.data.guestRoomSearchResults.searchParam);
         }
