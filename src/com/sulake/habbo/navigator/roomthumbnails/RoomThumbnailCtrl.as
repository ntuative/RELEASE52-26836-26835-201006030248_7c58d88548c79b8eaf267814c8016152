package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private var var_1552:IButtonWindow;
      ...
      private function refreshTab() : void
      {
         ...
         setEnabled(var_1553,this._model.mode != ThumbnailEditorModel.const_56);
         setEnabled(var_1552,this._model.mode != ThumbnailEditorModel.const_37);
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         var_1553 = IButtonWindow(find("top_tab"));
         var_1552 = IButtonWindow(find("obj_tab"));
         var_2017 = IWindowContainer(find("tile_grid"));
         var_2016 = IWindowContainer(find("now_editing_container"));
         ...
         Util.setProcDirectly(var_1553,onTopTabButton);
         Util.setProcDirectly(var_1552,onObjTabButton);
      }
      ...
      private function refreshPositionGrid() : void
      {
         ...
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_416)
            {
