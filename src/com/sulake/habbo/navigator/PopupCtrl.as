package com.sulake.habbo.navigator
{
   ...
   public class PopupCtrl
   {
      ...
      public function PopupCtrl(param1:HabboNavigator, param2:int, param3:int, param4:String)
      {
         ...
         var_343.addEventListener(TimerEvent.TIMER,onDisplayTimer);
      ...
      public function dispose() : void
      {
         ...
         if(var_343)
         {
            var_343.removeEventListener(TimerEvent.TIMER,onDisplayTimer);
            var_343.reset();
            var_343 = null;
         }
         if(var_301)
      ...
      public function showPopup(param1:IWindow) : void
      {
         if(var_50 == null)
         {
            var_50 = IWindowContainer(_navigator.getXmlWindow(var_1244));
            var_50.visible = false;
         ...
         var_50.x = _loc2_.x + var_1737 + param1.width;
