package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_804:RoomCreateViewCtrl;
      
      private var var_1680:RoomThumbnailRenderer;
      
      private var var_194:IHabboToolbar;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_564:RoomInfoViewCtrl;
      
      private var _catalog:IHabboCatalog;
      
      private var var_440:Tabs;
      
      private var var_253:MainViewCtrl;
      
      private var var_1679:Array;
      
      private var var_1007:GuestRoomPasswordInput;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_253 = new MainViewCtrl(this);
         var_564 = new RoomInfoViewCtrl(this);
         var_804 = new RoomCreateViewCtrl(this);
         var_1680 = new RoomThumbnailRenderer(this);
         var_1007 = new GuestRoomPasswordInput(this);
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         var_253.startSearch(Tabs.const_223,Tabs.const_317,param1);
         var_253.mainWindow.activate();
      }
      ...
      public function animateWindowOpen(param1:IWindowContainer) : void
      {
         ...
         {
            var_194.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_49,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var _loc3_:String = var_162.getKey("navigator.default_tab");
         switch(_loc3_)
         {
            case "popular":
               _loc4_ = 0;
      ...
      private function setHabboToolbarIcon() : void
      {
         if(var_194 != null)
         {
            var_194.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_120,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.settings != null && this._data.settings.homeRoomId > 0)
            {
               var_194.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_120,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         var_253.startSearch(Tabs.const_288,Tabs.const_242);
         var_440.getTab(Tabs.const_288).tabPageDecorator.tabSelected();
      }
      ...
      {
         var _loc1_:Boolean = var_253.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
