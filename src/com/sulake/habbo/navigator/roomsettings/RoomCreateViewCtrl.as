package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1347:Boolean = true;
      
      private var var_918:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         super();
         _navigator = param1;
         var_529 = new Timer(100);
         var_529.addEventListener(TimerEvent.TIMER,updateArrowPos);
         var_40 = new Array();
      ...
      private function prepare() : void
      {
         ...
         var_1093 = new TextFieldManager(_navigator,ITextFieldWindow(var_20.findChildByName("room_name_input")),25,null,_navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      public function dispose() : void
      {
         if(var_529)
         {
            var_529.removeEventListener(TimerEvent.TIMER,updateArrowPos);
            var_529.reset();
            var_529 = null;
         }
      }
      ...
      {
         var_1093.goBackToInitialState();
         var_1093.input.textBackgroundColor = 4294967295;
         var_918 = var_40[0];
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = var_1093.getText();
      ...
      {
         var _loc1_:Boolean = var_1093.checkMandatory(_navigator.getText("navigator.createroom.nameerr"));
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(var_918.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!var_1347 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            var_1347 = true;
            _loc3_.y = 1;
