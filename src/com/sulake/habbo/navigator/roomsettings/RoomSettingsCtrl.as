package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private function onConfirmRoomDelete(param1:WindowMouseEvent, param2:int) : void
      {
         ...
         _navigator.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_190,HabboToolbarIconEnum.ROOMINFO));
      }
      ...
      {
         if(param1 != this.var_391 || var_1008 < 1)
         {
            return;
         }
         var_1008 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1271)
         {
            this.var_821.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1321)
         {
            this.var_821.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1425)
         {
            this.var_1192.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1258)
         {
            setTagError(this.var_815,param3,"${navigator.roomsettings.unacceptablewords}");
            setTagError(this.var_814,param3,"${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1329)
         {
            setTagError(this.var_815,param3,"${navigator.roomsettings.nonuserchoosabletag}");
            setTagError(this.var_814,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1410)
         {
            this.var_1007.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
            this.var_821.displayError("Update failed: error " + param2);
         }
      }
      ...
      private function populateForm() : void
      {
         ...
         var_821.setText(_loc1_.name);
         var_1192.setText(_loc1_.description);
         var_1007.setText("");
         var_1188.setText("");
         ...
         setTag(var_815,_loc1_.tags[0]);
         setTag(var_814,_loc1_.tags[1]);
         if(var_1193)
         {
            if(_loc1_.allowPets)
            {
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.name = var_821.getText();
         _loc2_.description = var_1192.getText();
         ...
         {
            _loc8_ = var_1007.getText();
            _loc9_ = var_1188.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_1007.clearErrors();
               this.var_1188.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.allowFoodConsume = var_1191.isSelected;
         _loc2_.allowWalkThrough = var_1190.isSelected;
         _loc2_.hideWalls = var_686.isSelected;
         _loc2_.tags = new Array();
         addTag(var_815,_loc2_.tags);
         addTag(var_814,_loc2_.tags);
         this.clearErrors();
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         var_1470.visible = _inRoom;
         var_1763.visible = var_477;
         var_1764.visible = !var_477;
         if(var_477)
         {
         ...
         var_1473.text = !!var_477 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(_window,[var_1472.name,_thumbnailContainer.name,var_1011.name,var_1010.name,var_1189.name,var_1470.name],0,0);
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_762,onDoorModePasswordSelect);
         _loc2_.addEventListener(WindowEvent.const_846,onDoorModePasswordUnselect);
         ...
         this.var_821 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("room_name")),60);
         this.var_1192 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("description")),255);
         this.var_815 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("tag1")),30);
         this.var_814 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("tag2")),30);
         this.var_1007 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("password")),30);
         this.var_1188 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("password_confirm")),30);
         this.var_1193 = ICheckBoxWindow(_window.findChildByName("allow_pets_checkbox"));
         this.var_1191 = ICheckBoxWindow(_window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1190 = ICheckBoxWindow(_window.findChildByName("allow_walk_through_checkbox"));
         this.var_686 = ICheckBoxWindow(_window.findChildByName("hide_walls_checkbox"));
         ...
         var_1011 = IWindowContainer(_window.findChildByName("basic_settings_container"));
         var_1010 = IWindowContainer(_window.findChildByName("advanced_settings_container"));
         var_1470 = IWindowContainer(_window.findChildByName("switch_view_container"));
         ...
         var_1764 = ITextWindow(_window.findChildByName("basic_caption"));
