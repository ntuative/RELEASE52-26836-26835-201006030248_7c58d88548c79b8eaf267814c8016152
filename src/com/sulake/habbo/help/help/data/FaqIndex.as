package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      {
         super();
         var_715 = new FaqCategory(-999,"${help.faq.title.urgent}");
         _frontPageNormal = new FaqCategory(-9999,"${help.faq.title.normal}");
         var_716 = new FaqCategory(-99999,"${help.faq.title.searchresults}");
         var_128 = new Map();
      }
      ...
      {
         var _loc4_:* = null;
         if(var_715.hasItem(param1))
         {
            var_715.getItem(param1).answerText = param2;
         }
         if(_frontPageNormal.hasItem(param1))
         {
            _frontPageNormal.getItem(param1).answerText = param2;
         }
         if(var_716.hasItem(param1))
         {
            var_716.getItem(param1).answerText = param2;
         }
         var _loc3_:int = 0;
