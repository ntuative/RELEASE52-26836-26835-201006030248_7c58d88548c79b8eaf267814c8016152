package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private static const const_1446:int = 0;
      
      private static const const_1445:int = 0;
      ...
      private var var_1729:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         _windowManager.registerLocalizationParameter("info.client.version","version","26836-26835-201006030237");
         var_194 = param5;
         var_104 = new Map();
         var_104.add(HabboHelpViewEnum.const_1357,IHelpViewController(new PlaceholderView(this,_windowManager,_assetLibrary)));
         var_104.add(HabboHelpViewEnum.const_148,IHelpViewController(new HelpMainView(this,_windowManager,_assetLibrary)));
         var_104.add(HabboHelpViewEnum.const_434,IHelpViewController(new FaqBrowseTopView(this,_windowManager,_assetLibrary)));
         var_104.add(HabboHelpViewEnum.const_273,IHelpViewController(new FaqBrowseCategoryView(this,_windowManager,_assetLibrary)));
         var_104.add(HabboHelpViewEnum.const_243,IHelpViewController(new FaqBrowseEntry(this,_windowManager,_assetLibrary)));
         var_104.add(HabboHelpViewEnum.const_668,IHelpViewController(new FaqBrowseSearchResults(this,_windowManager,_assetLibrary)));
         var_104.add(HabboHelpViewEnum.const_323,IHelpViewController(new CallForHelpTopicSelection(this,_windowManager,_assetLibrary)));
         var_104.add(HabboHelpViewEnum.const_720,IHelpViewController(new CallForHelpTextInput(this,_windowManager,_assetLibrary)));
         var_104.add(HabboHelpViewEnum.const_226,IHelpViewController(new CallForHelpSentView(this,_windowManager,_assetLibrary,"help_cfh_thanks")));
         ...
         var_104.add(HabboHelpViewEnum.const_845,IHelpViewController(new CallForHelpPendingItemView(this,_windowManager,_assetLibrary)));
         var_104.add(HabboHelpViewEnum.const_683,IHelpViewController(new CallForHelpReportUserSelection(this,_windowManager,_assetLibrary)));
      }
      ...
      private function createWindow() : void
      {
         ...
         var_1455 = 0 - _loc3_.width;
         var_1456 = _window.height;
      }
      ...
      private function addBackButtonWindow() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(var_254 == HabboHelpViewEnum.const_148 || false)
         {
            return;
         }
         if(var_390 == null)
         {
            ...
            var_390 = _loc2_.buildFromXML(XML(_loc3_.content)) as IWindowContainer;
         }
         var _loc1_:IItemListWindow = _window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || var_390 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(var_390 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(var_390 as IWindow);
      ...
      {
         return var_104.getValue(var_254);
      }
      ...
      {
         var_1730 = param1;
         var _loc2_:IHelpViewController = var_104.getValue(HabboHelpViewEnum.const_148) as IHelpViewController;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            ...
            case CallForHelpResultEnum.const_879:
               showUI(HabboHelpViewEnum.const_845);
               break;
            case CallForHelpResultEnum.const_1031:
      ...
      {
         var _loc3_:* = null;
         if(var_254 == HabboHelpViewEnum.const_148)
         {
            return;
         }
         if(true)
         ...
         var _loc2_:IBitmapWrapperWindow = var_390.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         _window.height = _loc1_.height + var_1456;
         _window.width = _loc1_.width + var_1455;
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         if(_loc3_)
         {
            if(var_194 != null)
            {
               var_194.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_49,HabboToolbarIconEnum.HELP,_window));
            }
         }
      ...
      public function handleCallGuideBot() : void
      {
         ...
         hideUI();
         var_23.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_435));
      }
