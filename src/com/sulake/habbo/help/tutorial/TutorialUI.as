package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI implements INameChangeUI
   {
      ...
      public static const const_464:String = "TUI_GUIDEBOT_VIEW";
      ...
      public function TutorialUI(param1:HabboHelp)
      {
         ...
         _main.events.addEventListener(HabboHelpTutorialEvent.const_396,onTaskDoneEvent);
      }
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         if(var_33 != null && (var_33.id == const_218 || var_33.id == const_90))
         {
            showView(const_90);
         }
      }
      ...
      public function showView(param1:String) : void
      {
         ...
         _window.height = _loc2_.height + var_1456;
         _window.width = _loc2_.width + var_1455;
         if(_loc3_)
         {
            if(_window == null)
            {
      ...
      public function dispose() : void
      {
         ...
         if(_main)
         {
            ...
            _main.events.removeEventListener(HabboHelpTutorialEvent.const_396,onTaskDoneEvent);
            _main = null;
         }
      }
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_435:
               var_1056 = true;
               if(var_33 != null && var_33.id == const_464)
               {
                  showView(const_90);
               }
               break;
            case HabboHelpTutorialEvent.const_507:
               if(var_33 != null && var_33.id == const_325)
               {
                  var_1291 = true;
                  disposeWindow();
               }
      ...
      {
         var_1055 = true;
         if(var_33 != null && (var_33.id == const_325 || var_33.id == const_90))
         {
            showView(const_90);
         }
      }
