package com.sulake.habbo.help.hotelmerge
{
   ...
   public class HotelMergeNameChangeView
   {
      ...
      private static var var_1564:uint = 13232628;
      
      private static var var_2050:uint = 11129827;
      ...
      private var var_874:NameSuggestionListRenderer;
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(!var_883)
         {
            if(param1.type == WindowEvent.const_122)
            {
      ...
      public function showMainView() : void
      {
         if(!_window)
         {
            ...
            var_1296 = _window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_1146 || param1 == ChangeUserNameResultMessageEvent.var_1145)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         var_874 = new NameSuggestionListRenderer(var_29);
         var _loc6_:int = var_874.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1564;
