package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      public function AchievementNotification(param1:String, param2:int, param3:IAssetLibrary, param4:IHabboWindowManager, param5:IHabboLocalizationManager, param6:IHabboConfigurationManager, param7:ISessionDataManager)
      {
         ...
         var_1867 = param2;
         var_377 = param7;
         param7.events.addEventListener(BadgeImageReadyEvent.const_123,onBadgeImageReady);
         ...
         var_2287 = param5.getKey("notifications.text.achievement_facebook");
      ...
      public function dispose() : void
      {
         if(var_377 != null)
         {
            var_377.events.removeEventListener(BadgeImageReadyEvent.const_123,onBadgeImageReady);
            var_377 = null;
         }
         if(_window != null)
         {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               if(false)
               {
                  ExternalInterface.call("FlashExternalInterface.postAchievement",var_783,var_2287);
               }
               dispose();
               break;
      ...
      {
         _localizations.registerParameter(param1,"badge_name",_localizations.getKey("badge_name_" + var_783,var_783));
         _localizations.registerParameter(param1,"badge_desc",_localizations.getKey("badge_desc_" + var_783,var_783));
         _localizations.registerParameter(param1,"level",var_1867.toString());
         _localizations.registerParameter(param1,"name",var_377.userName);
         _localizations.registerParameter(param1,"realname",var_377.realName);
      }
   }
}
