package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private var var_1374:CoreComponent;
      
      private var var_1112:int = -1;
      
      private var var_938:LagWarningLogger = null;
      
      private var var_937:IHabboWindowManager;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_242 = new PerformanceTracker();
         var_243 = new LatencyTracker();
         var_938 = new LagWarningLogger();
         var_1373 = new Array(const_813);
         var _loc4_:int = 0;
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1339,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1278,Capabilities.serverString);
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboCommunicationEvent.const_748:
               trackLoginStep(HabboLoginTrackingStep.const_1305,String(_communication.port));
               break;
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(var_242 != null)
            {
               var_242.connection = param1;
            }
            if(var_243 != null)
            {
               var_243.communication = _communication;
               var_243.connection = param1;
            }
            if(var_938 != null)
            {
               var_938.connection = param1;
            }
         }
      }
      ...
      {
         var_162 = IHabboConfigurationManager(param2);
         if(var_162)
         {
            Component(var_162).events.addEventListener(HabboConfigurationEvent.const_181,onConfigurationLoaded);
            if(var_243 != null)
            {
               var_243.configuration = var_162;
            }
            if(var_242 != null)
            {
               var_242.configuration = var_162;
            }
         }
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_263.events.addEventListener(AdEvent.const_492,onRoomAdLoad);
      }
      ...
      private function onLagWarningEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case AvatarWalkWarpingWarningEvent.const_475:
               var_938.warpingDetected();
         }
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(var_937)
            {
               var_937.release(new IIDHabboWindowManager());
               var_937 = null;
            }
            if(var_263)
            {
            ...
            if(var_186)
            {
               if(true)
               {
                  ...
                  Component(var_186).events.removeEventListener(HabboFriendListTrackingEvent.const_327,onFriendlistTrackingEvent);
               }
            ...
            if(_roomEngine)
            {
               if(true)
               {
                  Component(_roomEngine).events.removeEventListener(AvatarWalkWarpingWarningEvent.const_475,onLagWarningEvent);
               }
      ...
      private function onConfigurationLoaded(param1:Event) : void
      {
         ...
         if(var_162)
         {
            if(var_938 != null)
            {
               var_938.configure(var_162);
            }
            Component(var_162).events.removeEventListener(HabboConfigurationEvent.const_181,onConfigurationLoaded);
         }
      }
      ...
      {
         trackLoginStep(HabboLoginTrackingStep.const_910);
         if(var_1374 != null)
         {
            var_1374.events.removeEventListener(HabboLoginTrackingStep.const_910,onCoreRunning);
         }
      }
      ...
      {
         var_937 = IHabboWindowManager(param2);
         if(var_937)
         {
      ...
      public function update(param1:uint) : void
      {
         ...
         if(var_1112 > -1 && _loc2_ < var_1112)
         {
            ++var_1629;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + var_1629);
         }
         if(var_1112 > -1 && _loc2_ - var_1112 > 15000)
         {
            ++var_1628;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + var_1628);
         }
         var_1112 = _loc2_;
         if(var_242 != null)
         {
            var_242.update(param1);
         }
         if(var_243 != null)
         {
            var_243.update(param1);
         }
      }
      
      public function trackLoginStep(param1:String, param2:String = null) : void
      {
         if(var_162 != null && Boolean(var_162.getKey("processlog.enabled") == false))
         {
            return;
         }
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(_roomEngine).events.addEventListener(AvatarWalkWarpingWarningEvent.const_475,onLagWarningEvent);
         Component(_roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_284,onRoomAdClick);
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(var_186).events.addEventListener(HabboFriendListTrackingEvent.const_327,onFriendlistTrackingEvent);
      }
      ...
      private function onError(param1:ErrorEvent) : void
      {
         ...
         if(param1.critical && !_crashed)
         {
            ...
            if(var_162)
            {
               if(var_162.keyExists("client.fatal.error.url"))
               {
                  _loc2_ = var_162.getKey("client.fatal.error.url");
                  ...
                  if(var_242 != null)
                  {
                     _loc4_["null"] = var_242.flashVersion;
                     _loc4_["null"] = var_242.averageUpdateInterval;
                  }
         ...
         logError(var_1374.getLastErrorMessage());
      }
