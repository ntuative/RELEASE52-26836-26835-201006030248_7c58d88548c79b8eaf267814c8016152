package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      private var var_1535:OpenedToWebPopup;
      
      private var var_842:IAvatarRenderManager;
      ...
      private var var_1536:AvatarSearchResults;
      ...
      private var var_1961:FriendListLookAndFeel;
      ...
      {
         var_1961 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         var_91 = new FriendCategories(new FriendCategoriesDeps(this));
         var_1536 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         {
            var_440.findTab(FriendListTab.const_93).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_91.addCategory(new FriendCategory(FriendCategory.const_894,getText("friendlist.friends")));
         var_91.addCategory(new FriendCategory(FriendCategory.const_380,getText("friendlist.friends.offlinecaption")));
         ...
         if(!var_502)
         {
            var_502 = new Timer(120000);
            var_502.addEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_502.start();
         }
         getBuddyRequests();
         registerListeners();
         var_194.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_120,HabboToolbarIconEnum.FRIENDLIST));
      ...
      override public function dispose() : void
      {
         ...
         {
            var_502.stop();
            var_502.removeEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_502 = null;
         }
         if(_windowManager)
         {
         ...
         if(var_842)
         {
            var_842.release(new IIDAvatarRenderManager());
            var_842 = null;
         }
         if(var_858)
         {
         ...
         if(var_604)
         {
            var_604.release(new IIDSessionDataManager());
            var_604 = null;
         }
         super.dispose();
      }
      ...
      {
         var _loc1_:String = var_162.getKey("client.minimail.embed.enabled");
         return _loc1_ == "true";
      }
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1536.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         var _loc2_:int = 0;
         if(var_604.hasUserRight("fuse_super_extended_buddylist"))
         {
            _loc2_ = 0;
         }
         else if(var_604.hasUserRight("fuse_extended_buddylist"))
         {
            _loc2_ = 0;
         }
      ...
      {
         var _loc2_:FriendListTab = var_440.findTab(FriendListTab.const_93);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc2_:IAvatarImage = var_842.createAvatarImage(param1,AvatarScaleType.SMALL);
         if(!_loc2_)
         {
            return null;
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FriendListTab = var_440.findTab(FriendListTab.const_93);
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_842 = param2 as IAvatarRenderManager;
      ...
      {
         return var_162.getKey(param1,param1,param2);
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(var_1535 == null)
         {
            var_1535 = new OpenedToWebPopup(this);
         }
         var_1535.show(x,y);
      }
