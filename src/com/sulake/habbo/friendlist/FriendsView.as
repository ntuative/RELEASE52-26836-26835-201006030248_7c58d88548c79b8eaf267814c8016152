package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      private var var_2178:IContainerButtonWindow;
      ...
      {
         var_2178 = initButton("open_minimail",onMinimailButtonClick,param1);
         var_2179 = initButton("open_homepage",onHomeButtonClick,param1);
         var_2180 = initButton("room_invite",onInviteButtonClick,param1);
         var_2181 = initButton("remove_friend",onRemoveButtonClick,param1);
         refreshButtons();
      }
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_2178,isEnableMinimailButton(_loc1_));
         setEnabled(var_2179,isEnableHomeButton(_loc1_));
         setEnabled(var_2180,isEnableInviteButton(_loc1_));
         setEnabled(var_2181,isEnableRemoveButton(_loc1_));
      }
