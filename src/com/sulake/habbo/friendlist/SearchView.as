package com.sulake.habbo.friendlist
{
   ...
   public class SearchView implements ITabView, ISearchView
   {
      ...
      {
         var_758 = ITextFieldWindow(param1.findChildByName("search_str"));
         var_758.procedure = onSearchInput;
         var_758.addEventListener(WindowKeyboardEvent.const_147,onSearchStrInput);
      ...
      private function refreshShading() : void
      {
         ...
         {
            var_51.getListItemAt(_loc1_).color = _friendList.laf.getRowShadingColor(FriendListTab.const_356,_loc1_ % 2 == 1);
            _loc1_++;
         }
      }
      ...
      private function onSearchStrInput(param1:Event) : void
      {
         ...
         else
         {
            ...
            {
               var_758.text = _loc6_.substring(0,_loc5_);
            }
         }
      }
