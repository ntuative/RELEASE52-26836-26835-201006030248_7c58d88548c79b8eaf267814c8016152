package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1450:String = "noconvinfo";
      
      private static const const_1449:String = "messageinput";
      ...
      private function prepare() : void
      {
         ...
         var_917 = IWindowContainer(var_15.content.findChildByName("main_content"));
         var_289 = IWindowContainer(var_15.content.findChildByName("footer"));
         var_1262.prepare(var_917);
         var_15.procedure = onWindow;
         var_15.content.setParamFlag(HabboWindowParam.const_899,false);
         var_15.content.setParamFlag(HabboWindowParam.const_1421,true);
         var_15.header.setParamFlag(HabboWindowParam.const_758,false);
         var_15.header.setParamFlag(HabboWindowParam.const_1025,true);
         var_15.content.setParamFlag(HabboWindowParam.const_758,false);
         var_15.content.setParamFlag(HabboWindowParam.const_1025,true);
         var_15.findChildByName("open_edit_ctgs_but").procedure = onEditCategoriesButtonClick;
         var_1261 = ITextWindow(var_15.findChildByName("info_text"));
         var_1261.text = "";
      ...
      private function refreshWindowSize() : void
      {
         ...
         var_289.y = Util.getLowestPoint(var_15.content);
         var_289.width = _friendList.tabs.windowWidth;
         ...
         var_15.scaler.setParamFlag(HabboWindowParam.const_1036,this._friendList.tabs.findSelectedTab() != null);
         var_15.scaler.setParamFlag(HabboWindowParam.const_758,false);
         var_15.scaler.setParamFlag(HabboWindowParam.const_899,false);
         var_15.scaler.x = 0 - var_15.scaler.width;
         var_15.scaler.y = 0 - var_15.scaler.height;
         var_1543 = var_15.height;
         var_1542 = var_15.width;
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = var_1543 == -1 ? 0 : int(0 - var_1543);
