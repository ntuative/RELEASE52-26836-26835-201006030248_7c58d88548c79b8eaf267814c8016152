package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1647:IMessageComposer;
      ...
      {
         var_896 = IWindowContainer(_main.getXmlWindow("chatlog_roomheader"));
         var_897 = IWindowContainer(_main.getXmlWindow("chatlog_chatline"));
         ...
         _main.connection.send(var_1647);
      ...
      {
         var _loc5_:* = null;
         var _loc2_:IWindowContainer = IWindowContainer(var_896.clone());
      ...
      {
         var _loc4_:IWindowContainer = IWindowContainer(var_897.clone());
         _loc4_.color = var_1310[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
