package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_1713:String = "open_issues";
      
      private var _window:IFrameWindow;
      
      private const const_1714:String = "picked_issues";
      
      private var _assets:IAssetLibrary;
      
      private var var_1446:IIssueBrowserView;
      
      private const const_1741:String = "closed_issues";
      
      private var _issueManager:IssueManager;
      
      private const const_1715:String = "my_issues";
      ...
      private function selectView(param1:String) : void
      {
         ...
         var_336.view.width = var_218.container.width;
         var_336.view.height = var_218.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case const_1715:
               if(var_1446 == null)
               {
                  var_1446 = new MyIssuesView(issueManager,this,var_218.container);
               }
               return var_1446;
            case const_1713:
               if(var_1448 == null)
               {
                  var_1448 = new OpenIssuesView(issueManager,this,var_218.container);
               }
               return var_1448;
            case const_1714:
               if(var_1447 == null)
               {
                  var_1447 = new PickedIssuesView(issueManager,this,var_218.container);
               }
               return var_1447;
            default:
               return null;
