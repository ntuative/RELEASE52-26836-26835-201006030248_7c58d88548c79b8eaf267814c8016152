package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_869,onSetToolbarIconBitmapEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_190,onRemoveToolbarIconEvent);
         ...
         events.addEventListener(HabboToolbarShowMenuEvent.const_478,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_536,onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_952,onHideWindowEvent);
         var_35 = true;
