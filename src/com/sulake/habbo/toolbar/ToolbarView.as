package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private var var_1466:Number = 15;
      ...
      private var var_124:Number = 50;
      
      private var var_1181:Number = 0;
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         ...
         var_124 = _window.width;
         var_193 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_59,HabboWindowStyle.const_1024,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         var_1005 = String(_loc7_.relocate_by_drag.@state) == "true";
         if(var_1005)
         {
         ...
         var_1181 = _loc7_.toolbar.@margin_bottom;
         var_1466 = _loc7_.toolbar.@min_group_margin;
         ...
         createGroupsFromXmlList(_loc8_,var_256,param1,param2,_window,var_272);
         createGroupsFromXmlList(_loc9_,var_580,param1,param2,var_193,var_272);
         alignWindows();
      }
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,var_124,var_476,param3);
         }
      }
      ...
      private function alignWindows() : void
      {
         ...
         {
            case "LEFT":
               _window.width = var_124;
               _window.height = _loc1_.height;
               _window.x = 0;
               _window.y = 0;
               var_193.x = var_124 + var_1467;
               var_193.y = 0;
               _loc4_ = 0;
               break;
            case "RIGHT":
               _window.width = var_124;
               _window.height = _loc1_.height;
               _window.x = _loc1_.width - var_124;
               _window.y = 0;
               var_193.x = 0;
               var_193.y = 0;
               _loc4_ = 0;
            ...
            case "TOP":
               ...
               _window.height = var_124;
               _window.x = 0;
               _window.y = 0;
               var_193.x = 0;
               var_193.y = var_124 + var_1467;
               _loc4_ = 0;
               break;
            case "BOTTOM":
               _window.width = _loc1_.width;
               _window.height = var_124;
               _window.x = 0;
               _window.y = _loc1_.height - var_124;
               var_193.x = 0;
               var_193.y = 0;
               _loc4_ = 0;
         }
         ...
         else
         {
            ...
            if(false)
            {
               ...
               {
                  _loc7_ = Number(Math.max(var_1466,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1181) / -1));
               }
               else
               {
                  _loc7_ = Number(Math.max(var_1466,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1181) / -1));
         ...
         _loc2_ = 0;
         while(_loc2_ < var_580.length)
         {
            _loc3_ = var_580[_loc2_];
            if(_loc3_ != null)
            {
      ...
      private function createGroupsFromXmlList(param1:XMLList, param2:Array, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IWindowContainer, param6:ToolbarBarMenuAnimator) : void
      {
         ...
         while(_loc10_ < param1.length())
         {
            ...
            _loc9_ = new ToolbarIconGroup(param3,param4,_loc10_,_events,param5,param6,var_124);
      ...
      private function getTargetOrientationFromXY(param1:Number, param2:Number) : String
      {
         ...
         if(param1 >= _loc3_.width - var_124)
         {
            return "RIGHT";
         }
         if(param2 <= var_124)
         ...
         if(param2 >= _loc3_.height - var_124)
         {
            return "BOTTOM";
         }
         return null;
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,var_124,var_476);
         }
      }
      ...
      private function getGroupForIcon(param1:String) : ToolbarIconGroup
      {
         ...
         _loc3_ = 0;
         while(_loc3_ < var_580.length)
         {
            _loc2_ = var_580[_loc3_];
            if(_loc2_.acceptsIcon(param1))
            {
               return _loc2_;
            }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,var_124,var_476);
         }
      }
