package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIcon
   {
      ...
      public function ToolbarIcon(param1:ToolbarIconGroup, param2:IHabboWindowManager, param3:IAssetLibrary, param4:String, param5:IEventDispatcher, param6:ToolbarBarMenuAnimator)
      {
         ...
         var_100 = param2.createWindow("TOOLBAR_ICON_" + param4 + "_REGION","",WindowType.const_395,HabboWindowStyle.const_42,HabboWindowParam.const_44,new Rectangle(0,0,1,1),onMouseEvent) as IRegionWindow;
      ...
      {
         return var_1570[var_1065.indexOf(param1)];
      }
      ...
      private function onMouseEvent(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK:
               if(var_272)
               {
                  var_272.repositionWindow(var_731,true);
               }
               if(_events != null)
               {
                  _loc4_ = new HabboToolbarEvent(HabboToolbarEvent.const_60);
                  _loc4_.iconId = var_731;
      ...
      public function menuLockedToIcon(param1:String) : Boolean
      {
         ...
         var _loc2_:MenuSettingsItem = var_885[var_616.indexOf(param1)];
      ...
      private function setTooltip() : void
      {
         ...
         {
            var_100.toolTipCaption = "${toolbar.icon.tooltip." + var_2066.toLowerCase() + "}";
         }
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Number, param4:String, param5:Point) : void
      {
         if(var_272 != null)
         {
            var_272.animateWindowIn(this,param1,param2,var_731,param3,param4,getMenuYieldList(param1));
         }
      }
      ...
      public function defineFromXML(param1:XML) : void
      {
         ...
         var_1065 = new Array();
         var_2066 = param1.@id;
         var_2065 = int(param1.@window_offset_from_icon);
         var_2067 = int(param1.@window_margin);
      ...
      public function hideWindow(param1:String, param2:IWindowContainer, param3:Number, param4:String) : void
      {
         if(var_272 != null)
         {
            var_272.hideWindow(param1,param2,var_731,param3);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer, param3:Number, param4:String) : void
      {
         if(var_272 != null)
         {
            var_272.positionWindow(this,param1,param2,var_731,param3,getMenuYieldList(param1));
         }
      }
      ...
      private function setAnimator() : void
      {
         ...
         var _loc1_:StateItem = getCurrentStateObject();
         if(_loc1_ != null && var_1063)
         {
            if(_loc1_.frames == null)
            {
               return;
            }
            var_418 = new ToolbarIconAnimator(_loc1_,_assetLibrary,_window,var_82,_y,_bitmapData);
            if(false)
            {
               var_730 = new Timer(_loc1_.timer);
               var_730.addEventListener(TimerEvent.TIMER,updateAnimator);
               var_730.start();
            }
            if(_loc1_.bounce)
            {
      ...
      {
         return var_2067 + var_514.windowMargin;
      }
