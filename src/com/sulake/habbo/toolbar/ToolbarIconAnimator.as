package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconAnimator
   {
      ...
      public function ToolbarIconAnimator(param1:StateItem, param2:IAssetLibrary, param3:IBitmapWrapperWindow, param4:Number, param5:Number, param6:BitmapData = null)
      {
         ...
         var_1293 = param1.loop;
         if(param1.background != null)
         {
            var_879 = getBitmapDataFromAsset(param1.background,param2);
         }
         ...
         else
         {
            ...
            if(_loc8_ != null)
            {
               var_877.push(new XML());
               var_878.push(_loc8_);
            }
         }
         if(param6 != null)
         {
            var_878[var_53] = param6.clone();
         }
      ...
      {
         if(var_1293 == true || var_729 == 0)
         {
            if(false)
            {
               ++var_53;
               if(var_53 >= var_877.length)
               {
                  var_53 = 0;
                  ++var_729;
               }
      ...
      {
         return var_1293 == false && var_729 == 1 && var_1185 != var_35;
      }
      ...
      private function setAsset(param1:IBitmapWrapperWindow, param2:BitmapData) : void
      {
         ...
         if(var_879 != null)
         {
            _loc3_ = new BitmapData(Math.max(param2.width,var_879.width),Math.max(param2.height,var_879.height));
            _loc3_.copyPixels(var_879,var_879.rect,new Point(0,0));
      ...
      {
         var _loc2_:* = null;
         if(var_53 <= var_878.length)
         {
            _loc2_ = var_878[var_53];
